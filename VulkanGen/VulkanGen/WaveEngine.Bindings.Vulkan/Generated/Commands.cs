...
namespace WaveEngine.Bindings.Vulkan
{
	public static unsafe partial class VulkanNative
	{
		...
		[UnmanagedFunctionPointer(CallConv)]
		private delegate VkResult vkGetPhysicalDeviceImageFormatPropertiesDelegate(VkPhysicalDevice physicalDevice, VkFormat format, VkImageType type, VkImageTiling tiling, VkImageUsageFlagBits usage, VkImageCreateFlagBits flags, VkImageFormatProperties* pImageFormatProperties);
		private static vkGetPhysicalDeviceImageFormatPropertiesDelegate vkGetPhysicalDeviceImageFormatProperties_ptr;
		public static VkResult vkGetPhysicalDeviceImageFormatProperties(VkPhysicalDevice physicalDevice, VkFormat format, VkImageType type, VkImageTiling tiling, VkImageUsageFlagBits usage, VkImageCreateFlagBits flags, VkImageFormatProperties* pImageFormatProperties)
		...
		[UnmanagedFunctionPointer(CallConv)]
		private delegate void vkGetPhysicalDeviceSparseImageFormatPropertiesDelegate(VkPhysicalDevice physicalDevice, VkFormat format, VkImageType type, VkSampleCountFlagBits samples, VkImageUsageFlagBits usage, VkImageTiling tiling, uint* pPropertyCount, VkSparseImageFormatProperties* pProperties);
		private static vkGetPhysicalDeviceSparseImageFormatPropertiesDelegate vkGetPhysicalDeviceSparseImageFormatProperties_ptr;
		public static void vkGetPhysicalDeviceSparseImageFormatProperties(VkPhysicalDevice physicalDevice, VkFormat format, VkImageType type, VkSampleCountFlagBits samples, VkImageUsageFlagBits usage, VkImageTiling tiling, uint* pPropertyCount, VkSparseImageFormatProperties* pProperties)
		...
		[UnmanagedFunctionPointer(CallConv)]
		private delegate VkResult vkGetQueryPoolResultsDelegate(VkDevice device, VkQueryPool queryPool, uint firstQuery, uint queryCount, UIntPtr dataSize, void* pData, ulong stride, VkQueryResultFlagBits flags);
		private static vkGetQueryPoolResultsDelegate vkGetQueryPoolResults_ptr;
		public static VkResult vkGetQueryPoolResults(VkDevice device, VkQueryPool queryPool, uint firstQuery, uint queryCount, UIntPtr dataSize, void* pData, ulong stride, VkQueryResultFlagBits flags)
		...
		[UnmanagedFunctionPointer(CallConv)]
		private delegate VkResult vkResetCommandPoolDelegate(VkDevice device, VkCommandPool commandPool, VkCommandPoolResetFlagBits flags);
		private static vkResetCommandPoolDelegate vkResetCommandPool_ptr;
		public static VkResult vkResetCommandPool(VkDevice device, VkCommandPool commandPool, VkCommandPoolResetFlagBits flags)
		...
		[UnmanagedFunctionPointer(CallConv)]
		private delegate VkResult vkResetCommandBufferDelegate(VkCommandBuffer commandBuffer, VkCommandBufferResetFlagBits flags);
		private static vkResetCommandBufferDelegate vkResetCommandBuffer_ptr;
		public static VkResult vkResetCommandBuffer(VkCommandBuffer commandBuffer, VkCommandBufferResetFlagBits flags)
		...
		[UnmanagedFunctionPointer(CallConv)]
		private delegate void vkCmdSetStencilCompareMaskDelegate(VkCommandBuffer commandBuffer, VkStencilFaceFlagBits faceMask, uint compareMask);
		private static vkCmdSetStencilCompareMaskDelegate vkCmdSetStencilCompareMask_ptr;
		public static void vkCmdSetStencilCompareMask(VkCommandBuffer commandBuffer, VkStencilFaceFlagBits faceMask, uint compareMask)
			=> vkCmdSetStencilCompareMask_ptr(commandBuffer, faceMask, compareMask);

		[UnmanagedFunctionPointer(CallConv)]
		private delegate void vkCmdSetStencilWriteMaskDelegate(VkCommandBuffer commandBuffer, VkStencilFaceFlagBits faceMask, uint writeMask);
		private static vkCmdSetStencilWriteMaskDelegate vkCmdSetStencilWriteMask_ptr;
		public static void vkCmdSetStencilWriteMask(VkCommandBuffer commandBuffer, VkStencilFaceFlagBits faceMask, uint writeMask)
			=> vkCmdSetStencilWriteMask_ptr(commandBuffer, faceMask, writeMask);

		[UnmanagedFunctionPointer(CallConv)]
		private delegate void vkCmdSetStencilReferenceDelegate(VkCommandBuffer commandBuffer, VkStencilFaceFlagBits faceMask, uint reference);
		private static vkCmdSetStencilReferenceDelegate vkCmdSetStencilReference_ptr;
		public static void vkCmdSetStencilReference(VkCommandBuffer commandBuffer, VkStencilFaceFlagBits faceMask, uint reference)
		...
		[UnmanagedFunctionPointer(CallConv)]
		private delegate void vkCmdSetEventDelegate(VkCommandBuffer commandBuffer, VkEvent vkEvent, VkPipelineStageFlagBits stageMask);
		private static vkCmdSetEventDelegate vkCmdSetEvent_ptr;
		public static void vkCmdSetEvent(VkCommandBuffer commandBuffer, VkEvent vkEvent, VkPipelineStageFlagBits stageMask)
			=> vkCmdSetEvent_ptr(commandBuffer, vkEvent, stageMask);

		[UnmanagedFunctionPointer(CallConv)]
		private delegate void vkCmdResetEventDelegate(VkCommandBuffer commandBuffer, VkEvent vkEvent, VkPipelineStageFlagBits stageMask);
		private static vkCmdResetEventDelegate vkCmdResetEvent_ptr;
		public static void vkCmdResetEvent(VkCommandBuffer commandBuffer, VkEvent vkEvent, VkPipelineStageFlagBits stageMask)
		...
		[UnmanagedFunctionPointer(CallConv)]
		private delegate void vkCmdPipelineBarrierDelegate(VkCommandBuffer commandBuffer, VkPipelineStageFlagBits srcStageMask, VkPipelineStageFlagBits dstStageMask, VkDependencyFlagBits dependencyFlags, uint memoryBarrierCount, VkMemoryBarrier* pMemoryBarriers, uint bufferMemoryBarrierCount, VkBufferMemoryBarrier* pBufferMemoryBarriers, uint imageMemoryBarrierCount, VkImageMemoryBarrier* pImageMemoryBarriers);
		private static vkCmdPipelineBarrierDelegate vkCmdPipelineBarrier_ptr;
		public static void vkCmdPipelineBarrier(VkCommandBuffer commandBuffer, VkPipelineStageFlagBits srcStageMask, VkPipelineStageFlagBits dstStageMask, VkDependencyFlagBits dependencyFlags, uint memoryBarrierCount, VkMemoryBarrier* pMemoryBarriers, uint bufferMemoryBarrierCount, VkBufferMemoryBarrier* pBufferMemoryBarriers, uint imageMemoryBarrierCount, VkImageMemoryBarrier* pImageMemoryBarriers)
		...
		[UnmanagedFunctionPointer(CallConv)]
		private delegate void vkCmdBeginQueryDelegate(VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint query, VkQueryControlFlagBits flags);
		private static vkCmdBeginQueryDelegate vkCmdBeginQuery_ptr;
		public static void vkCmdBeginQuery(VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint query, VkQueryControlFlagBits flags)
		...
		[UnmanagedFunctionPointer(CallConv)]
		private delegate void vkCmdCopyQueryPoolResultsDelegate(VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint firstQuery, uint queryCount, VkBuffer dstBuffer, ulong dstOffset, ulong stride, VkQueryResultFlagBits flags);
		private static vkCmdCopyQueryPoolResultsDelegate vkCmdCopyQueryPoolResults_ptr;
		public static void vkCmdCopyQueryPoolResults(VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint firstQuery, uint queryCount, VkBuffer dstBuffer, ulong dstOffset, ulong stride, VkQueryResultFlagBits flags)
			=> vkCmdCopyQueryPoolResults_ptr(commandBuffer, queryPool, firstQuery, queryCount, dstBuffer, dstOffset, stride, flags);

		[UnmanagedFunctionPointer(CallConv)]
		private delegate void vkCmdPushConstantsDelegate(VkCommandBuffer commandBuffer, VkPipelineLayout layout, VkShaderStageFlagBits stageFlags, uint offset, uint size, void* pValues);
		private static vkCmdPushConstantsDelegate vkCmdPushConstants_ptr;
		public static void vkCmdPushConstants(VkCommandBuffer commandBuffer, VkPipelineLayout layout, VkShaderStageFlagBits stageFlags, uint offset, uint size, void* pValues)
		...
		[UnmanagedFunctionPointer(CallConv)]
		private delegate void vkGetDeviceGroupPeerMemoryFeaturesDelegate(VkDevice device, uint heapIndex, uint localDeviceIndex, uint remoteDeviceIndex, VkPeerMemoryFeatureFlagBits* pPeerMemoryFeatures);
		private static vkGetDeviceGroupPeerMemoryFeaturesDelegate vkGetDeviceGroupPeerMemoryFeatures_ptr;
		public static void vkGetDeviceGroupPeerMemoryFeatures(VkDevice device, uint heapIndex, uint localDeviceIndex, uint remoteDeviceIndex, VkPeerMemoryFeatureFlagBits* pPeerMemoryFeatures)
		...
		[UnmanagedFunctionPointer(CallConv)]
		private delegate VkResult vkGetSwapchainGrallocUsageANDROIDDelegate(VkDevice device, VkFormat format, VkImageUsageFlagBits imageUsage, int* grallocUsage);
		private static vkGetSwapchainGrallocUsageANDROIDDelegate vkGetSwapchainGrallocUsageANDROID_ptr;
		public static VkResult vkGetSwapchainGrallocUsageANDROID(VkDevice device, VkFormat format, VkImageUsageFlagBits imageUsage, int* grallocUsage)
		...
		[UnmanagedFunctionPointer(CallConv)]
		private delegate VkResult vkGetSwapchainGrallocUsage2ANDROIDDelegate(VkDevice device, VkFormat format, VkImageUsageFlagBits imageUsage, VkSwapchainImageUsageFlagBitsANDROID swapchainImageUsage, ulong* grallocConsumerUsage, ulong* grallocProducerUsage);
		private static vkGetSwapchainGrallocUsage2ANDROIDDelegate vkGetSwapchainGrallocUsage2ANDROID_ptr;
		public static VkResult vkGetSwapchainGrallocUsage2ANDROID(VkDevice device, VkFormat format, VkImageUsageFlagBits imageUsage, VkSwapchainImageUsageFlagBitsANDROID swapchainImageUsage, ulong* grallocConsumerUsage, ulong* grallocProducerUsage)
		...
		[UnmanagedFunctionPointer(CallConv)]
		private delegate void vkDebugReportMessageEXTDelegate(VkInstance instance, VkDebugReportFlagBitsEXT flags, VkDebugReportObjectTypeEXT objectType, ulong vkObject, UIntPtr location, int messageCode, byte* pLayerPrefix, byte* pMessage);
		private static vkDebugReportMessageEXTDelegate vkDebugReportMessageEXT_ptr;
		public static void vkDebugReportMessageEXT(VkInstance instance, VkDebugReportFlagBitsEXT flags, VkDebugReportObjectTypeEXT objectType, ulong vkObject, UIntPtr location, int messageCode, byte* pLayerPrefix, byte* pMessage)
		...
		[UnmanagedFunctionPointer(CallConv)]
		private delegate void vkCmdBeginQueryIndexedEXTDelegate(VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint query, VkQueryControlFlagBits flags, uint index);
		private static vkCmdBeginQueryIndexedEXTDelegate vkCmdBeginQueryIndexedEXT_ptr;
		public static void vkCmdBeginQueryIndexedEXT(VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint query, VkQueryControlFlagBits flags, uint index)
		...
		public static VkResult vkGetPhysicalDeviceExternalImageFormatPropertiesNV(VkPhysicalDevice physicalDevice, VkFormat format, VkImageType type, VkImageTiling tiling, VkImageUsageFlagBits usage, VkImageCreateFlagBits flags, VkExternalMemoryHandleTypeFlagBitsNV externalHandleType, VkExternalImageFormatPropertiesNV* pExternalImageFormatProperties)
		...
		[UnmanagedFunctionPointer(CallConv)]
		private delegate VkResult vkGetMemoryWin32HandleNVDelegate(VkDevice device, VkDeviceMemory memory, VkExternalMemoryHandleTypeFlagBitsNV handleType, IntPtr pHandle);
		private static vkGetMemoryWin32HandleNVDelegate vkGetMemoryWin32HandleNV_ptr;
		public static VkResult vkGetMemoryWin32HandleNV(VkDevice device, VkDeviceMemory memory, VkExternalMemoryHandleTypeFlagBitsNV handleType, IntPtr pHandle)
		...
		[UnmanagedFunctionPointer(CallConv)]
		private delegate void vkSubmitDebugUtilsMessageEXTDelegate(VkInstance instance, VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity, VkDebugUtilsMessageTypeFlagBitsEXT messageTypes, VkDebugUtilsMessengerCallbackDataEXT* pCallbackData);
		private static vkSubmitDebugUtilsMessageEXTDelegate vkSubmitDebugUtilsMessageEXT_ptr;
		public static void vkSubmitDebugUtilsMessageEXT(VkInstance instance, VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity, VkDebugUtilsMessageTypeFlagBitsEXT messageTypes, VkDebugUtilsMessengerCallbackDataEXT* pCallbackData)
		...
		{
			nativeLib.LoadFunction(default, "vkGetInstanceProcAddr", out vkGetInstanceProcAddr_ptr);
			nativeLib.LoadFunction(default, "vkCreateInstance", out vkCreateInstance_ptr);

			VkInstanceCreateInfo createInfo = new VkInstanceCreateInfo();
			VkInstance instance;
			var result = VulkanNative.vkCreateInstance(&createInfo, null, &instance);
			if (result != VkResult.VK_SUCCESS)
			{
				throw new Exception("Error creating dummy vulkan instance");
			}

			nativeLib.LoadFunction(instance, "vkDestroyInstance", out vkDestroyInstance_ptr);
			nativeLib.LoadFunction(instance, "vkEnumeratePhysicalDevices", out vkEnumeratePhysicalDevices_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceFeatures", out vkGetPhysicalDeviceFeatures_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceFormatProperties", out vkGetPhysicalDeviceFormatProperties_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceImageFormatProperties", out vkGetPhysicalDeviceImageFormatProperties_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceProperties", out vkGetPhysicalDeviceProperties_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceQueueFamilyProperties", out vkGetPhysicalDeviceQueueFamilyProperties_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceMemoryProperties", out vkGetPhysicalDeviceMemoryProperties_ptr);
			nativeLib.LoadFunction(instance, "vkGetDeviceProcAddr", out vkGetDeviceProcAddr_ptr);
			nativeLib.LoadFunction(instance, "vkCreateDevice", out vkCreateDevice_ptr);
			nativeLib.LoadFunction(instance, "vkDestroyDevice", out vkDestroyDevice_ptr);
			nativeLib.LoadFunction(instance, "vkEnumerateInstanceExtensionProperties", out vkEnumerateInstanceExtensionProperties_ptr);
			nativeLib.LoadFunction(instance, "vkEnumerateDeviceExtensionProperties", out vkEnumerateDeviceExtensionProperties_ptr);
			nativeLib.LoadFunction(instance, "vkEnumerateInstanceLayerProperties", out vkEnumerateInstanceLayerProperties_ptr);
			nativeLib.LoadFunction(instance, "vkEnumerateDeviceLayerProperties", out vkEnumerateDeviceLayerProperties_ptr);
			nativeLib.LoadFunction(instance, "vkGetDeviceQueue", out vkGetDeviceQueue_ptr);
			nativeLib.LoadFunction(instance, "vkQueueSubmit", out vkQueueSubmit_ptr);
			nativeLib.LoadFunction(instance, "vkQueueWaitIdle", out vkQueueWaitIdle_ptr);
			nativeLib.LoadFunction(instance, "vkDeviceWaitIdle", out vkDeviceWaitIdle_ptr);
			nativeLib.LoadFunction(instance, "vkAllocateMemory", out vkAllocateMemory_ptr);
			nativeLib.LoadFunction(instance, "vkFreeMemory", out vkFreeMemory_ptr);
			nativeLib.LoadFunction(instance, "vkMapMemory", out vkMapMemory_ptr);
			nativeLib.LoadFunction(instance, "vkUnmapMemory", out vkUnmapMemory_ptr);
			nativeLib.LoadFunction(instance, "vkFlushMappedMemoryRanges", out vkFlushMappedMemoryRanges_ptr);
			nativeLib.LoadFunction(instance, "vkInvalidateMappedMemoryRanges", out vkInvalidateMappedMemoryRanges_ptr);
			nativeLib.LoadFunction(instance, "vkGetDeviceMemoryCommitment", out vkGetDeviceMemoryCommitment_ptr);
			nativeLib.LoadFunction(instance, "vkBindBufferMemory", out vkBindBufferMemory_ptr);
			nativeLib.LoadFunction(instance, "vkBindImageMemory", out vkBindImageMemory_ptr);
			nativeLib.LoadFunction(instance, "vkGetBufferMemoryRequirements", out vkGetBufferMemoryRequirements_ptr);
			nativeLib.LoadFunction(instance, "vkGetImageMemoryRequirements", out vkGetImageMemoryRequirements_ptr);
			nativeLib.LoadFunction(instance, "vkGetImageSparseMemoryRequirements", out vkGetImageSparseMemoryRequirements_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceSparseImageFormatProperties", out vkGetPhysicalDeviceSparseImageFormatProperties_ptr);
			nativeLib.LoadFunction(instance, "vkQueueBindSparse", out vkQueueBindSparse_ptr);
			nativeLib.LoadFunction(instance, "vkCreateFence", out vkCreateFence_ptr);
			nativeLib.LoadFunction(instance, "vkDestroyFence", out vkDestroyFence_ptr);
			nativeLib.LoadFunction(instance, "vkResetFences", out vkResetFences_ptr);
			nativeLib.LoadFunction(instance, "vkGetFenceStatus", out vkGetFenceStatus_ptr);
			nativeLib.LoadFunction(instance, "vkWaitForFences", out vkWaitForFences_ptr);
			nativeLib.LoadFunction(instance, "vkCreateSemaphore", out vkCreateSemaphore_ptr);
			nativeLib.LoadFunction(instance, "vkDestroySemaphore", out vkDestroySemaphore_ptr);
			nativeLib.LoadFunction(instance, "vkCreateEvent", out vkCreateEvent_ptr);
			nativeLib.LoadFunction(instance, "vkDestroyEvent", out vkDestroyEvent_ptr);
			nativeLib.LoadFunction(instance, "vkGetEventStatus", out vkGetEventStatus_ptr);
			nativeLib.LoadFunction(instance, "vkSetEvent", out vkSetEvent_ptr);
			nativeLib.LoadFunction(instance, "vkResetEvent", out vkResetEvent_ptr);
			nativeLib.LoadFunction(instance, "vkCreateQueryPool", out vkCreateQueryPool_ptr);
			nativeLib.LoadFunction(instance, "vkDestroyQueryPool", out vkDestroyQueryPool_ptr);
			nativeLib.LoadFunction(instance, "vkGetQueryPoolResults", out vkGetQueryPoolResults_ptr);
			nativeLib.LoadFunction(instance, "vkCreateBuffer", out vkCreateBuffer_ptr);
			nativeLib.LoadFunction(instance, "vkDestroyBuffer", out vkDestroyBuffer_ptr);
			nativeLib.LoadFunction(instance, "vkCreateBufferView", out vkCreateBufferView_ptr);
			nativeLib.LoadFunction(instance, "vkDestroyBufferView", out vkDestroyBufferView_ptr);
			nativeLib.LoadFunction(instance, "vkCreateImage", out vkCreateImage_ptr);
			nativeLib.LoadFunction(instance, "vkDestroyImage", out vkDestroyImage_ptr);
			nativeLib.LoadFunction(instance, "vkGetImageSubresourceLayout", out vkGetImageSubresourceLayout_ptr);
			nativeLib.LoadFunction(instance, "vkCreateImageView", out vkCreateImageView_ptr);
			nativeLib.LoadFunction(instance, "vkDestroyImageView", out vkDestroyImageView_ptr);
			nativeLib.LoadFunction(instance, "vkCreateShaderModule", out vkCreateShaderModule_ptr);
			nativeLib.LoadFunction(instance, "vkDestroyShaderModule", out vkDestroyShaderModule_ptr);
			nativeLib.LoadFunction(instance, "vkCreatePipelineCache", out vkCreatePipelineCache_ptr);
			nativeLib.LoadFunction(instance, "vkDestroyPipelineCache", out vkDestroyPipelineCache_ptr);
			nativeLib.LoadFunction(instance, "vkGetPipelineCacheData", out vkGetPipelineCacheData_ptr);
			nativeLib.LoadFunction(instance, "vkMergePipelineCaches", out vkMergePipelineCaches_ptr);
			nativeLib.LoadFunction(instance, "vkCreateGraphicsPipelines", out vkCreateGraphicsPipelines_ptr);
			nativeLib.LoadFunction(instance, "vkCreateComputePipelines", out vkCreateComputePipelines_ptr);
			nativeLib.LoadFunction(instance, "vkDestroyPipeline", out vkDestroyPipeline_ptr);
			nativeLib.LoadFunction(instance, "vkCreatePipelineLayout", out vkCreatePipelineLayout_ptr);
			nativeLib.LoadFunction(instance, "vkDestroyPipelineLayout", out vkDestroyPipelineLayout_ptr);
			nativeLib.LoadFunction(instance, "vkCreateSampler", out vkCreateSampler_ptr);
			nativeLib.LoadFunction(instance, "vkDestroySampler", out vkDestroySampler_ptr);
			nativeLib.LoadFunction(instance, "vkCreateDescriptorSetLayout", out vkCreateDescriptorSetLayout_ptr);
			nativeLib.LoadFunction(instance, "vkDestroyDescriptorSetLayout", out vkDestroyDescriptorSetLayout_ptr);
			nativeLib.LoadFunction(instance, "vkCreateDescriptorPool", out vkCreateDescriptorPool_ptr);
			nativeLib.LoadFunction(instance, "vkDestroyDescriptorPool", out vkDestroyDescriptorPool_ptr);
			nativeLib.LoadFunction(instance, "vkResetDescriptorPool", out vkResetDescriptorPool_ptr);
			nativeLib.LoadFunction(instance, "vkAllocateDescriptorSets", out vkAllocateDescriptorSets_ptr);
			nativeLib.LoadFunction(instance, "vkFreeDescriptorSets", out vkFreeDescriptorSets_ptr);
			nativeLib.LoadFunction(instance, "vkUpdateDescriptorSets", out vkUpdateDescriptorSets_ptr);
			nativeLib.LoadFunction(instance, "vkCreateFramebuffer", out vkCreateFramebuffer_ptr);
			nativeLib.LoadFunction(instance, "vkDestroyFramebuffer", out vkDestroyFramebuffer_ptr);
			nativeLib.LoadFunction(instance, "vkCreateRenderPass", out vkCreateRenderPass_ptr);
			nativeLib.LoadFunction(instance, "vkDestroyRenderPass", out vkDestroyRenderPass_ptr);
			nativeLib.LoadFunction(instance, "vkGetRenderAreaGranularity", out vkGetRenderAreaGranularity_ptr);
			nativeLib.LoadFunction(instance, "vkCreateCommandPool", out vkCreateCommandPool_ptr);
			nativeLib.LoadFunction(instance, "vkDestroyCommandPool", out vkDestroyCommandPool_ptr);
			nativeLib.LoadFunction(instance, "vkResetCommandPool", out vkResetCommandPool_ptr);
			nativeLib.LoadFunction(instance, "vkAllocateCommandBuffers", out vkAllocateCommandBuffers_ptr);
			nativeLib.LoadFunction(instance, "vkFreeCommandBuffers", out vkFreeCommandBuffers_ptr);
			nativeLib.LoadFunction(instance, "vkBeginCommandBuffer", out vkBeginCommandBuffer_ptr);
			nativeLib.LoadFunction(instance, "vkEndCommandBuffer", out vkEndCommandBuffer_ptr);
			nativeLib.LoadFunction(instance, "vkResetCommandBuffer", out vkResetCommandBuffer_ptr);
			nativeLib.LoadFunction(instance, "vkCmdBindPipeline", out vkCmdBindPipeline_ptr);
			nativeLib.LoadFunction(instance, "vkCmdSetViewport", out vkCmdSetViewport_ptr);
			nativeLib.LoadFunction(instance, "vkCmdSetScissor", out vkCmdSetScissor_ptr);
			nativeLib.LoadFunction(instance, "vkCmdSetLineWidth", out vkCmdSetLineWidth_ptr);
			nativeLib.LoadFunction(instance, "vkCmdSetDepthBias", out vkCmdSetDepthBias_ptr);
			nativeLib.LoadFunction(instance, "vkCmdSetBlendConstants", out vkCmdSetBlendConstants_ptr);
			nativeLib.LoadFunction(instance, "vkCmdSetDepthBounds", out vkCmdSetDepthBounds_ptr);
			nativeLib.LoadFunction(instance, "vkCmdSetStencilCompareMask", out vkCmdSetStencilCompareMask_ptr);
			nativeLib.LoadFunction(instance, "vkCmdSetStencilWriteMask", out vkCmdSetStencilWriteMask_ptr);
			nativeLib.LoadFunction(instance, "vkCmdSetStencilReference", out vkCmdSetStencilReference_ptr);
			nativeLib.LoadFunction(instance, "vkCmdBindDescriptorSets", out vkCmdBindDescriptorSets_ptr);
			nativeLib.LoadFunction(instance, "vkCmdBindIndexBuffer", out vkCmdBindIndexBuffer_ptr);
			nativeLib.LoadFunction(instance, "vkCmdBindVertexBuffers", out vkCmdBindVertexBuffers_ptr);
			nativeLib.LoadFunction(instance, "vkCmdDraw", out vkCmdDraw_ptr);
			nativeLib.LoadFunction(instance, "vkCmdDrawIndexed", out vkCmdDrawIndexed_ptr);
			nativeLib.LoadFunction(instance, "vkCmdDrawIndirect", out vkCmdDrawIndirect_ptr);
			nativeLib.LoadFunction(instance, "vkCmdDrawIndexedIndirect", out vkCmdDrawIndexedIndirect_ptr);
			nativeLib.LoadFunction(instance, "vkCmdDispatch", out vkCmdDispatch_ptr);
			nativeLib.LoadFunction(instance, "vkCmdDispatchIndirect", out vkCmdDispatchIndirect_ptr);
			nativeLib.LoadFunction(instance, "vkCmdCopyBuffer", out vkCmdCopyBuffer_ptr);
			nativeLib.LoadFunction(instance, "vkCmdCopyImage", out vkCmdCopyImage_ptr);
			nativeLib.LoadFunction(instance, "vkCmdBlitImage", out vkCmdBlitImage_ptr);
			nativeLib.LoadFunction(instance, "vkCmdCopyBufferToImage", out vkCmdCopyBufferToImage_ptr);
			nativeLib.LoadFunction(instance, "vkCmdCopyImageToBuffer", out vkCmdCopyImageToBuffer_ptr);
			nativeLib.LoadFunction(instance, "vkCmdUpdateBuffer", out vkCmdUpdateBuffer_ptr);
			nativeLib.LoadFunction(instance, "vkCmdFillBuffer", out vkCmdFillBuffer_ptr);
			nativeLib.LoadFunction(instance, "vkCmdClearColorImage", out vkCmdClearColorImage_ptr);
			nativeLib.LoadFunction(instance, "vkCmdClearDepthStencilImage", out vkCmdClearDepthStencilImage_ptr);
			nativeLib.LoadFunction(instance, "vkCmdClearAttachments", out vkCmdClearAttachments_ptr);
			nativeLib.LoadFunction(instance, "vkCmdResolveImage", out vkCmdResolveImage_ptr);
			nativeLib.LoadFunction(instance, "vkCmdSetEvent", out vkCmdSetEvent_ptr);
			nativeLib.LoadFunction(instance, "vkCmdResetEvent", out vkCmdResetEvent_ptr);
			nativeLib.LoadFunction(instance, "vkCmdWaitEvents", out vkCmdWaitEvents_ptr);
			nativeLib.LoadFunction(instance, "vkCmdPipelineBarrier", out vkCmdPipelineBarrier_ptr);
			nativeLib.LoadFunction(instance, "vkCmdBeginQuery", out vkCmdBeginQuery_ptr);
			nativeLib.LoadFunction(instance, "vkCmdEndQuery", out vkCmdEndQuery_ptr);
			nativeLib.LoadFunction(instance, "vkCmdResetQueryPool", out vkCmdResetQueryPool_ptr);
			nativeLib.LoadFunction(instance, "vkCmdWriteTimestamp", out vkCmdWriteTimestamp_ptr);
			nativeLib.LoadFunction(instance, "vkCmdCopyQueryPoolResults", out vkCmdCopyQueryPoolResults_ptr);
			nativeLib.LoadFunction(instance, "vkCmdPushConstants", out vkCmdPushConstants_ptr);
			nativeLib.LoadFunction(instance, "vkCmdBeginRenderPass", out vkCmdBeginRenderPass_ptr);
			nativeLib.LoadFunction(instance, "vkCmdNextSubpass", out vkCmdNextSubpass_ptr);
			nativeLib.LoadFunction(instance, "vkCmdEndRenderPass", out vkCmdEndRenderPass_ptr);
			nativeLib.LoadFunction(instance, "vkCmdExecuteCommands", out vkCmdExecuteCommands_ptr);
			nativeLib.LoadFunction(instance, "vkEnumerateInstanceVersion", out vkEnumerateInstanceVersion_ptr);
			nativeLib.LoadFunction(instance, "vkBindBufferMemory2", out vkBindBufferMemory2_ptr);
			nativeLib.LoadFunction(instance, "vkBindImageMemory2", out vkBindImageMemory2_ptr);
			nativeLib.LoadFunction(instance, "vkGetDeviceGroupPeerMemoryFeatures", out vkGetDeviceGroupPeerMemoryFeatures_ptr);
			nativeLib.LoadFunction(instance, "vkCmdSetDeviceMask", out vkCmdSetDeviceMask_ptr);
			nativeLib.LoadFunction(instance, "vkCmdDispatchBase", out vkCmdDispatchBase_ptr);
			nativeLib.LoadFunction(instance, "vkEnumeratePhysicalDeviceGroups", out vkEnumeratePhysicalDeviceGroups_ptr);
			nativeLib.LoadFunction(instance, "vkGetImageMemoryRequirements2", out vkGetImageMemoryRequirements2_ptr);
			nativeLib.LoadFunction(instance, "vkGetBufferMemoryRequirements2", out vkGetBufferMemoryRequirements2_ptr);
			nativeLib.LoadFunction(instance, "vkGetImageSparseMemoryRequirements2", out vkGetImageSparseMemoryRequirements2_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceFeatures2", out vkGetPhysicalDeviceFeatures2_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceProperties2", out vkGetPhysicalDeviceProperties2_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceFormatProperties2", out vkGetPhysicalDeviceFormatProperties2_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceImageFormatProperties2", out vkGetPhysicalDeviceImageFormatProperties2_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceQueueFamilyProperties2", out vkGetPhysicalDeviceQueueFamilyProperties2_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceMemoryProperties2", out vkGetPhysicalDeviceMemoryProperties2_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceSparseImageFormatProperties2", out vkGetPhysicalDeviceSparseImageFormatProperties2_ptr);
			nativeLib.LoadFunction(instance, "vkTrimCommandPool", out vkTrimCommandPool_ptr);
			nativeLib.LoadFunction(instance, "vkGetDeviceQueue2", out vkGetDeviceQueue2_ptr);
			nativeLib.LoadFunction(instance, "vkCreateSamplerYcbcrConversion", out vkCreateSamplerYcbcrConversion_ptr);
			nativeLib.LoadFunction(instance, "vkDestroySamplerYcbcrConversion", out vkDestroySamplerYcbcrConversion_ptr);
			nativeLib.LoadFunction(instance, "vkCreateDescriptorUpdateTemplate", out vkCreateDescriptorUpdateTemplate_ptr);
			nativeLib.LoadFunction(instance, "vkDestroyDescriptorUpdateTemplate", out vkDestroyDescriptorUpdateTemplate_ptr);
			nativeLib.LoadFunction(instance, "vkUpdateDescriptorSetWithTemplate", out vkUpdateDescriptorSetWithTemplate_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceExternalBufferProperties", out vkGetPhysicalDeviceExternalBufferProperties_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceExternalFenceProperties", out vkGetPhysicalDeviceExternalFenceProperties_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceExternalSemaphoreProperties", out vkGetPhysicalDeviceExternalSemaphoreProperties_ptr);
			nativeLib.LoadFunction(instance, "vkGetDescriptorSetLayoutSupport", out vkGetDescriptorSetLayoutSupport_ptr);
			nativeLib.LoadFunction(instance, "vkCmdDrawIndirectCount", out vkCmdDrawIndirectCount_ptr);
			nativeLib.LoadFunction(instance, "vkCmdDrawIndexedIndirectCount", out vkCmdDrawIndexedIndirectCount_ptr);
			nativeLib.LoadFunction(instance, "vkCreateRenderPass2", out vkCreateRenderPass2_ptr);
			nativeLib.LoadFunction(instance, "vkCmdBeginRenderPass2", out vkCmdBeginRenderPass2_ptr);
			nativeLib.LoadFunction(instance, "vkCmdNextSubpass2", out vkCmdNextSubpass2_ptr);
			nativeLib.LoadFunction(instance, "vkCmdEndRenderPass2", out vkCmdEndRenderPass2_ptr);
			nativeLib.LoadFunction(instance, "vkResetQueryPool", out vkResetQueryPool_ptr);
			nativeLib.LoadFunction(instance, "vkGetSemaphoreCounterValue", out vkGetSemaphoreCounterValue_ptr);
			nativeLib.LoadFunction(instance, "vkWaitSemaphores", out vkWaitSemaphores_ptr);
			nativeLib.LoadFunction(instance, "vkSignalSemaphore", out vkSignalSemaphore_ptr);
			nativeLib.LoadFunction(instance, "vkGetBufferDeviceAddress", out vkGetBufferDeviceAddress_ptr);
			nativeLib.LoadFunction(instance, "vkGetBufferOpaqueCaptureAddress", out vkGetBufferOpaqueCaptureAddress_ptr);
			nativeLib.LoadFunction(instance, "vkGetDeviceMemoryOpaqueCaptureAddress", out vkGetDeviceMemoryOpaqueCaptureAddress_ptr);
			nativeLib.LoadFunction(instance, "vkDestroySurfaceKHR", out vkDestroySurfaceKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceSurfaceSupportKHR", out vkGetPhysicalDeviceSurfaceSupportKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceSurfaceCapabilitiesKHR", out vkGetPhysicalDeviceSurfaceCapabilitiesKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceSurfaceFormatsKHR", out vkGetPhysicalDeviceSurfaceFormatsKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceSurfacePresentModesKHR", out vkGetPhysicalDeviceSurfacePresentModesKHR_ptr);
			nativeLib.LoadFunction(instance, "vkCreateSwapchainKHR", out vkCreateSwapchainKHR_ptr);
			nativeLib.LoadFunction(instance, "vkDestroySwapchainKHR", out vkDestroySwapchainKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetSwapchainImagesKHR", out vkGetSwapchainImagesKHR_ptr);
			nativeLib.LoadFunction(instance, "vkAcquireNextImageKHR", out vkAcquireNextImageKHR_ptr);
			nativeLib.LoadFunction(instance, "vkQueuePresentKHR", out vkQueuePresentKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceDisplayPropertiesKHR", out vkGetPhysicalDeviceDisplayPropertiesKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceDisplayPlanePropertiesKHR", out vkGetPhysicalDeviceDisplayPlanePropertiesKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetDisplayPlaneSupportedDisplaysKHR", out vkGetDisplayPlaneSupportedDisplaysKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetDisplayModePropertiesKHR", out vkGetDisplayModePropertiesKHR_ptr);
			nativeLib.LoadFunction(instance, "vkCreateDisplayModeKHR", out vkCreateDisplayModeKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetDisplayPlaneCapabilitiesKHR", out vkGetDisplayPlaneCapabilitiesKHR_ptr);
			nativeLib.LoadFunction(instance, "vkCreateDisplayPlaneSurfaceKHR", out vkCreateDisplayPlaneSurfaceKHR_ptr);
			nativeLib.LoadFunction(instance, "vkCreateSharedSwapchainsKHR", out vkCreateSharedSwapchainsKHR_ptr);
			nativeLib.LoadFunction(instance, "vkCreateXlibSurfaceKHR", out vkCreateXlibSurfaceKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceXlibPresentationSupportKHR", out vkGetPhysicalDeviceXlibPresentationSupportKHR_ptr);
			nativeLib.LoadFunction(instance, "vkCreateXcbSurfaceKHR", out vkCreateXcbSurfaceKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceXcbPresentationSupportKHR", out vkGetPhysicalDeviceXcbPresentationSupportKHR_ptr);
			nativeLib.LoadFunction(instance, "vkCreateWaylandSurfaceKHR", out vkCreateWaylandSurfaceKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceWaylandPresentationSupportKHR", out vkGetPhysicalDeviceWaylandPresentationSupportKHR_ptr);
			nativeLib.LoadFunction(instance, "vkCreateAndroidSurfaceKHR", out vkCreateAndroidSurfaceKHR_ptr);
			nativeLib.LoadFunction(instance, "vkCreateWin32SurfaceKHR", out vkCreateWin32SurfaceKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceWin32PresentationSupportKHR", out vkGetPhysicalDeviceWin32PresentationSupportKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetSwapchainGrallocUsageANDROID", out vkGetSwapchainGrallocUsageANDROID_ptr);
			nativeLib.LoadFunction(instance, "vkAcquireImageANDROID", out vkAcquireImageANDROID_ptr);
			nativeLib.LoadFunction(instance, "vkQueueSignalReleaseImageANDROID", out vkQueueSignalReleaseImageANDROID_ptr);
			nativeLib.LoadFunction(instance, "vkGetSwapchainGrallocUsage2ANDROID", out vkGetSwapchainGrallocUsage2ANDROID_ptr);
			nativeLib.LoadFunction(instance, "vkCreateDebugReportCallbackEXT", out vkCreateDebugReportCallbackEXT_ptr);
			nativeLib.LoadFunction(instance, "vkDestroyDebugReportCallbackEXT", out vkDestroyDebugReportCallbackEXT_ptr);
			nativeLib.LoadFunction(instance, "vkDebugReportMessageEXT", out vkDebugReportMessageEXT_ptr);
			nativeLib.LoadFunction(instance, "vkDebugMarkerSetObjectTagEXT", out vkDebugMarkerSetObjectTagEXT_ptr);
			nativeLib.LoadFunction(instance, "vkDebugMarkerSetObjectNameEXT", out vkDebugMarkerSetObjectNameEXT_ptr);
			nativeLib.LoadFunction(instance, "vkCmdDebugMarkerBeginEXT", out vkCmdDebugMarkerBeginEXT_ptr);
			nativeLib.LoadFunction(instance, "vkCmdDebugMarkerEndEXT", out vkCmdDebugMarkerEndEXT_ptr);
			nativeLib.LoadFunction(instance, "vkCmdDebugMarkerInsertEXT", out vkCmdDebugMarkerInsertEXT_ptr);
			nativeLib.LoadFunction(instance, "vkCmdBindTransformFeedbackBuffersEXT", out vkCmdBindTransformFeedbackBuffersEXT_ptr);
			nativeLib.LoadFunction(instance, "vkCmdBeginTransformFeedbackEXT", out vkCmdBeginTransformFeedbackEXT_ptr);
			nativeLib.LoadFunction(instance, "vkCmdEndTransformFeedbackEXT", out vkCmdEndTransformFeedbackEXT_ptr);
			nativeLib.LoadFunction(instance, "vkCmdBeginQueryIndexedEXT", out vkCmdBeginQueryIndexedEXT_ptr);
			nativeLib.LoadFunction(instance, "vkCmdEndQueryIndexedEXT", out vkCmdEndQueryIndexedEXT_ptr);
			nativeLib.LoadFunction(instance, "vkCmdDrawIndirectByteCountEXT", out vkCmdDrawIndirectByteCountEXT_ptr);
			nativeLib.LoadFunction(instance, "vkGetImageViewHandleNVX", out vkGetImageViewHandleNVX_ptr);
			nativeLib.LoadFunction(instance, "vkGetImageViewAddressNVX", out vkGetImageViewAddressNVX_ptr);
			nativeLib.LoadFunction(instance, "vkGetShaderInfoAMD", out vkGetShaderInfoAMD_ptr);
			nativeLib.LoadFunction(instance, "vkCreateStreamDescriptorSurfaceGGP", out vkCreateStreamDescriptorSurfaceGGP_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceExternalImageFormatPropertiesNV", out vkGetPhysicalDeviceExternalImageFormatPropertiesNV_ptr);
			nativeLib.LoadFunction(instance, "vkGetMemoryWin32HandleNV", out vkGetMemoryWin32HandleNV_ptr);
			nativeLib.LoadFunction(instance, "vkCreateViSurfaceNN", out vkCreateViSurfaceNN_ptr);
			nativeLib.LoadFunction(instance, "vkGetMemoryWin32HandleKHR", out vkGetMemoryWin32HandleKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetMemoryWin32HandlePropertiesKHR", out vkGetMemoryWin32HandlePropertiesKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetMemoryFdKHR", out vkGetMemoryFdKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetMemoryFdPropertiesKHR", out vkGetMemoryFdPropertiesKHR_ptr);
			nativeLib.LoadFunction(instance, "vkImportSemaphoreWin32HandleKHR", out vkImportSemaphoreWin32HandleKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetSemaphoreWin32HandleKHR", out vkGetSemaphoreWin32HandleKHR_ptr);
			nativeLib.LoadFunction(instance, "vkImportSemaphoreFdKHR", out vkImportSemaphoreFdKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetSemaphoreFdKHR", out vkGetSemaphoreFdKHR_ptr);
			nativeLib.LoadFunction(instance, "vkCmdPushDescriptorSetKHR", out vkCmdPushDescriptorSetKHR_ptr);
			nativeLib.LoadFunction(instance, "vkCmdBeginConditionalRenderingEXT", out vkCmdBeginConditionalRenderingEXT_ptr);
			nativeLib.LoadFunction(instance, "vkCmdEndConditionalRenderingEXT", out vkCmdEndConditionalRenderingEXT_ptr);
			nativeLib.LoadFunction(instance, "vkCmdSetViewportWScalingNV", out vkCmdSetViewportWScalingNV_ptr);
			nativeLib.LoadFunction(instance, "vkReleaseDisplayEXT", out vkReleaseDisplayEXT_ptr);
			nativeLib.LoadFunction(instance, "vkAcquireXlibDisplayEXT", out vkAcquireXlibDisplayEXT_ptr);
			nativeLib.LoadFunction(instance, "vkGetRandROutputDisplayEXT", out vkGetRandROutputDisplayEXT_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceSurfaceCapabilities2EXT", out vkGetPhysicalDeviceSurfaceCapabilities2EXT_ptr);
			nativeLib.LoadFunction(instance, "vkDisplayPowerControlEXT", out vkDisplayPowerControlEXT_ptr);
			nativeLib.LoadFunction(instance, "vkRegisterDeviceEventEXT", out vkRegisterDeviceEventEXT_ptr);
			nativeLib.LoadFunction(instance, "vkRegisterDisplayEventEXT", out vkRegisterDisplayEventEXT_ptr);
			nativeLib.LoadFunction(instance, "vkGetSwapchainCounterEXT", out vkGetSwapchainCounterEXT_ptr);
			nativeLib.LoadFunction(instance, "vkGetRefreshCycleDurationGOOGLE", out vkGetRefreshCycleDurationGOOGLE_ptr);
			nativeLib.LoadFunction(instance, "vkGetPastPresentationTimingGOOGLE", out vkGetPastPresentationTimingGOOGLE_ptr);
			nativeLib.LoadFunction(instance, "vkCmdSetDiscardRectangleEXT", out vkCmdSetDiscardRectangleEXT_ptr);
			nativeLib.LoadFunction(instance, "vkSetHdrMetadataEXT", out vkSetHdrMetadataEXT_ptr);
			nativeLib.LoadFunction(instance, "vkGetSwapchainStatusKHR", out vkGetSwapchainStatusKHR_ptr);
			nativeLib.LoadFunction(instance, "vkImportFenceWin32HandleKHR", out vkImportFenceWin32HandleKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetFenceWin32HandleKHR", out vkGetFenceWin32HandleKHR_ptr);
			nativeLib.LoadFunction(instance, "vkImportFenceFdKHR", out vkImportFenceFdKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetFenceFdKHR", out vkGetFenceFdKHR_ptr);
			nativeLib.LoadFunction(instance, "vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR", out vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR", out vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR_ptr);
			nativeLib.LoadFunction(instance, "vkAcquireProfilingLockKHR", out vkAcquireProfilingLockKHR_ptr);
			nativeLib.LoadFunction(instance, "vkReleaseProfilingLockKHR", out vkReleaseProfilingLockKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceSurfaceCapabilities2KHR", out vkGetPhysicalDeviceSurfaceCapabilities2KHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceSurfaceFormats2KHR", out vkGetPhysicalDeviceSurfaceFormats2KHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceDisplayProperties2KHR", out vkGetPhysicalDeviceDisplayProperties2KHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceDisplayPlaneProperties2KHR", out vkGetPhysicalDeviceDisplayPlaneProperties2KHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetDisplayModeProperties2KHR", out vkGetDisplayModeProperties2KHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetDisplayPlaneCapabilities2KHR", out vkGetDisplayPlaneCapabilities2KHR_ptr);
			nativeLib.LoadFunction(instance, "vkCreateIOSSurfaceMVK", out vkCreateIOSSurfaceMVK_ptr);
			nativeLib.LoadFunction(instance, "vkCreateMacOSSurfaceMVK", out vkCreateMacOSSurfaceMVK_ptr);
			nativeLib.LoadFunction(instance, "vkSetDebugUtilsObjectNameEXT", out vkSetDebugUtilsObjectNameEXT_ptr);
			nativeLib.LoadFunction(instance, "vkSetDebugUtilsObjectTagEXT", out vkSetDebugUtilsObjectTagEXT_ptr);
			nativeLib.LoadFunction(instance, "vkQueueBeginDebugUtilsLabelEXT", out vkQueueBeginDebugUtilsLabelEXT_ptr);
			nativeLib.LoadFunction(instance, "vkQueueEndDebugUtilsLabelEXT", out vkQueueEndDebugUtilsLabelEXT_ptr);
			nativeLib.LoadFunction(instance, "vkQueueInsertDebugUtilsLabelEXT", out vkQueueInsertDebugUtilsLabelEXT_ptr);
			nativeLib.LoadFunction(instance, "vkCmdBeginDebugUtilsLabelEXT", out vkCmdBeginDebugUtilsLabelEXT_ptr);
			nativeLib.LoadFunction(instance, "vkCmdEndDebugUtilsLabelEXT", out vkCmdEndDebugUtilsLabelEXT_ptr);
			nativeLib.LoadFunction(instance, "vkCmdInsertDebugUtilsLabelEXT", out vkCmdInsertDebugUtilsLabelEXT_ptr);
			nativeLib.LoadFunction(instance, "vkCreateDebugUtilsMessengerEXT", out vkCreateDebugUtilsMessengerEXT_ptr);
			nativeLib.LoadFunction(instance, "vkDestroyDebugUtilsMessengerEXT", out vkDestroyDebugUtilsMessengerEXT_ptr);
			nativeLib.LoadFunction(instance, "vkSubmitDebugUtilsMessageEXT", out vkSubmitDebugUtilsMessageEXT_ptr);
			nativeLib.LoadFunction(instance, "vkGetAndroidHardwareBufferPropertiesANDROID", out vkGetAndroidHardwareBufferPropertiesANDROID_ptr);
			nativeLib.LoadFunction(instance, "vkGetMemoryAndroidHardwareBufferANDROID", out vkGetMemoryAndroidHardwareBufferANDROID_ptr);
			nativeLib.LoadFunction(instance, "vkCmdSetSampleLocationsEXT", out vkCmdSetSampleLocationsEXT_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceMultisamplePropertiesEXT", out vkGetPhysicalDeviceMultisamplePropertiesEXT_ptr);
			nativeLib.LoadFunction(instance, "vkCreateAccelerationStructureKHR", out vkCreateAccelerationStructureKHR_ptr);
			nativeLib.LoadFunction(instance, "vkDestroyAccelerationStructureKHR", out vkDestroyAccelerationStructureKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetAccelerationStructureMemoryRequirementsKHR", out vkGetAccelerationStructureMemoryRequirementsKHR_ptr);
			nativeLib.LoadFunction(instance, "vkBindAccelerationStructureMemoryKHR", out vkBindAccelerationStructureMemoryKHR_ptr);
			nativeLib.LoadFunction(instance, "vkCmdBuildAccelerationStructureKHR", out vkCmdBuildAccelerationStructureKHR_ptr);
			nativeLib.LoadFunction(instance, "vkCmdBuildAccelerationStructureIndirectKHR", out vkCmdBuildAccelerationStructureIndirectKHR_ptr);
			nativeLib.LoadFunction(instance, "vkBuildAccelerationStructureKHR", out vkBuildAccelerationStructureKHR_ptr);
			nativeLib.LoadFunction(instance, "vkCopyAccelerationStructureKHR", out vkCopyAccelerationStructureKHR_ptr);
			nativeLib.LoadFunction(instance, "vkCopyAccelerationStructureToMemoryKHR", out vkCopyAccelerationStructureToMemoryKHR_ptr);
			nativeLib.LoadFunction(instance, "vkCopyMemoryToAccelerationStructureKHR", out vkCopyMemoryToAccelerationStructureKHR_ptr);
			nativeLib.LoadFunction(instance, "vkWriteAccelerationStructuresPropertiesKHR", out vkWriteAccelerationStructuresPropertiesKHR_ptr);
			nativeLib.LoadFunction(instance, "vkCmdCopyAccelerationStructureKHR", out vkCmdCopyAccelerationStructureKHR_ptr);
			nativeLib.LoadFunction(instance, "vkCmdCopyAccelerationStructureToMemoryKHR", out vkCmdCopyAccelerationStructureToMemoryKHR_ptr);
			nativeLib.LoadFunction(instance, "vkCmdCopyMemoryToAccelerationStructureKHR", out vkCmdCopyMemoryToAccelerationStructureKHR_ptr);
			nativeLib.LoadFunction(instance, "vkCmdTraceRaysKHR", out vkCmdTraceRaysKHR_ptr);
			nativeLib.LoadFunction(instance, "vkCreateRayTracingPipelinesKHR", out vkCreateRayTracingPipelinesKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetRayTracingShaderGroupHandlesKHR", out vkGetRayTracingShaderGroupHandlesKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetAccelerationStructureDeviceAddressKHR", out vkGetAccelerationStructureDeviceAddressKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetRayTracingCaptureReplayShaderGroupHandlesKHR", out vkGetRayTracingCaptureReplayShaderGroupHandlesKHR_ptr);
			nativeLib.LoadFunction(instance, "vkCmdWriteAccelerationStructuresPropertiesKHR", out vkCmdWriteAccelerationStructuresPropertiesKHR_ptr);
			nativeLib.LoadFunction(instance, "vkCmdTraceRaysIndirectKHR", out vkCmdTraceRaysIndirectKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetDeviceAccelerationStructureCompatibilityKHR", out vkGetDeviceAccelerationStructureCompatibilityKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetImageDrmFormatModifierPropertiesEXT", out vkGetImageDrmFormatModifierPropertiesEXT_ptr);
			nativeLib.LoadFunction(instance, "vkCreateValidationCacheEXT", out vkCreateValidationCacheEXT_ptr);
			nativeLib.LoadFunction(instance, "vkDestroyValidationCacheEXT", out vkDestroyValidationCacheEXT_ptr);
			nativeLib.LoadFunction(instance, "vkMergeValidationCachesEXT", out vkMergeValidationCachesEXT_ptr);
			nativeLib.LoadFunction(instance, "vkGetValidationCacheDataEXT", out vkGetValidationCacheDataEXT_ptr);
			nativeLib.LoadFunction(instance, "vkCmdBindShadingRateImageNV", out vkCmdBindShadingRateImageNV_ptr);
			nativeLib.LoadFunction(instance, "vkCmdSetViewportShadingRatePaletteNV", out vkCmdSetViewportShadingRatePaletteNV_ptr);
			nativeLib.LoadFunction(instance, "vkCmdSetCoarseSampleOrderNV", out vkCmdSetCoarseSampleOrderNV_ptr);
			nativeLib.LoadFunction(instance, "vkCreateAccelerationStructureNV", out vkCreateAccelerationStructureNV_ptr);
			nativeLib.LoadFunction(instance, "vkGetAccelerationStructureMemoryRequirementsNV", out vkGetAccelerationStructureMemoryRequirementsNV_ptr);
			nativeLib.LoadFunction(instance, "vkCmdBuildAccelerationStructureNV", out vkCmdBuildAccelerationStructureNV_ptr);
			nativeLib.LoadFunction(instance, "vkCmdCopyAccelerationStructureNV", out vkCmdCopyAccelerationStructureNV_ptr);
			nativeLib.LoadFunction(instance, "vkCmdTraceRaysNV", out vkCmdTraceRaysNV_ptr);
			nativeLib.LoadFunction(instance, "vkCreateRayTracingPipelinesNV", out vkCreateRayTracingPipelinesNV_ptr);
			nativeLib.LoadFunction(instance, "vkGetAccelerationStructureHandleNV", out vkGetAccelerationStructureHandleNV_ptr);
			nativeLib.LoadFunction(instance, "vkCompileDeferredNV", out vkCompileDeferredNV_ptr);
			nativeLib.LoadFunction(instance, "vkGetMemoryHostPointerPropertiesEXT", out vkGetMemoryHostPointerPropertiesEXT_ptr);
			nativeLib.LoadFunction(instance, "vkCmdWriteBufferMarkerAMD", out vkCmdWriteBufferMarkerAMD_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceCalibrateableTimeDomainsEXT", out vkGetPhysicalDeviceCalibrateableTimeDomainsEXT_ptr);
			nativeLib.LoadFunction(instance, "vkGetCalibratedTimestampsEXT", out vkGetCalibratedTimestampsEXT_ptr);
			nativeLib.LoadFunction(instance, "vkCmdDrawMeshTasksNV", out vkCmdDrawMeshTasksNV_ptr);
			nativeLib.LoadFunction(instance, "vkCmdDrawMeshTasksIndirectNV", out vkCmdDrawMeshTasksIndirectNV_ptr);
			nativeLib.LoadFunction(instance, "vkCmdDrawMeshTasksIndirectCountNV", out vkCmdDrawMeshTasksIndirectCountNV_ptr);
			nativeLib.LoadFunction(instance, "vkCmdSetExclusiveScissorNV", out vkCmdSetExclusiveScissorNV_ptr);
			nativeLib.LoadFunction(instance, "vkCmdSetCheckpointNV", out vkCmdSetCheckpointNV_ptr);
			nativeLib.LoadFunction(instance, "vkGetQueueCheckpointDataNV", out vkGetQueueCheckpointDataNV_ptr);
			nativeLib.LoadFunction(instance, "vkInitializePerformanceApiINTEL", out vkInitializePerformanceApiINTEL_ptr);
			nativeLib.LoadFunction(instance, "vkUninitializePerformanceApiINTEL", out vkUninitializePerformanceApiINTEL_ptr);
			nativeLib.LoadFunction(instance, "vkCmdSetPerformanceMarkerINTEL", out vkCmdSetPerformanceMarkerINTEL_ptr);
			nativeLib.LoadFunction(instance, "vkCmdSetPerformanceStreamMarkerINTEL", out vkCmdSetPerformanceStreamMarkerINTEL_ptr);
			nativeLib.LoadFunction(instance, "vkCmdSetPerformanceOverrideINTEL", out vkCmdSetPerformanceOverrideINTEL_ptr);
			nativeLib.LoadFunction(instance, "vkAcquirePerformanceConfigurationINTEL", out vkAcquirePerformanceConfigurationINTEL_ptr);
			nativeLib.LoadFunction(instance, "vkReleasePerformanceConfigurationINTEL", out vkReleasePerformanceConfigurationINTEL_ptr);
			nativeLib.LoadFunction(instance, "vkQueueSetPerformanceConfigurationINTEL", out vkQueueSetPerformanceConfigurationINTEL_ptr);
			nativeLib.LoadFunction(instance, "vkGetPerformanceParameterINTEL", out vkGetPerformanceParameterINTEL_ptr);
			nativeLib.LoadFunction(instance, "vkSetLocalDimmingAMD", out vkSetLocalDimmingAMD_ptr);
			nativeLib.LoadFunction(instance, "vkCreateImagePipeSurfaceFUCHSIA", out vkCreateImagePipeSurfaceFUCHSIA_ptr);
			nativeLib.LoadFunction(instance, "vkCreateMetalSurfaceEXT", out vkCreateMetalSurfaceEXT_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceToolPropertiesEXT", out vkGetPhysicalDeviceToolPropertiesEXT_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceCooperativeMatrixPropertiesNV", out vkGetPhysicalDeviceCooperativeMatrixPropertiesNV_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV", out vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV_ptr);
			nativeLib.LoadFunction(instance, "vkGetPhysicalDeviceSurfacePresentModes2EXT", out vkGetPhysicalDeviceSurfacePresentModes2EXT_ptr);
			nativeLib.LoadFunction(instance, "vkAcquireFullScreenExclusiveModeEXT", out vkAcquireFullScreenExclusiveModeEXT_ptr);
			nativeLib.LoadFunction(instance, "vkReleaseFullScreenExclusiveModeEXT", out vkReleaseFullScreenExclusiveModeEXT_ptr);
			nativeLib.LoadFunction(instance, "vkCreateHeadlessSurfaceEXT", out vkCreateHeadlessSurfaceEXT_ptr);
			nativeLib.LoadFunction(instance, "vkCmdSetLineStippleEXT", out vkCmdSetLineStippleEXT_ptr);
			nativeLib.LoadFunction(instance, "vkCreateDeferredOperationKHR", out vkCreateDeferredOperationKHR_ptr);
			nativeLib.LoadFunction(instance, "vkDestroyDeferredOperationKHR", out vkDestroyDeferredOperationKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetDeferredOperationMaxConcurrencyKHR", out vkGetDeferredOperationMaxConcurrencyKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetDeferredOperationResultKHR", out vkGetDeferredOperationResultKHR_ptr);
			nativeLib.LoadFunction(instance, "vkDeferredOperationJoinKHR", out vkDeferredOperationJoinKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetPipelineExecutablePropertiesKHR", out vkGetPipelineExecutablePropertiesKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetPipelineExecutableStatisticsKHR", out vkGetPipelineExecutableStatisticsKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetPipelineExecutableInternalRepresentationsKHR", out vkGetPipelineExecutableInternalRepresentationsKHR_ptr);
			nativeLib.LoadFunction(instance, "vkGetGeneratedCommandsMemoryRequirementsNV", out vkGetGeneratedCommandsMemoryRequirementsNV_ptr);
			nativeLib.LoadFunction(instance, "vkCmdPreprocessGeneratedCommandsNV", out vkCmdPreprocessGeneratedCommandsNV_ptr);
			nativeLib.LoadFunction(instance, "vkCmdExecuteGeneratedCommandsNV", out vkCmdExecuteGeneratedCommandsNV_ptr);
			nativeLib.LoadFunction(instance, "vkCmdBindPipelineShaderGroupNV", out vkCmdBindPipelineShaderGroupNV_ptr);
			nativeLib.LoadFunction(instance, "vkCreateIndirectCommandsLayoutNV", out vkCreateIndirectCommandsLayoutNV_ptr);
			nativeLib.LoadFunction(instance, "vkDestroyIndirectCommandsLayoutNV", out vkDestroyIndirectCommandsLayoutNV_ptr);
		}
	}
}
