...
namespace Evergine.Bindings.Vulkan
{
	public static unsafe partial class VulkanNative
	{
		...
		public static void LoadFunctionPointers(VkInstance instance = default)
		{
			...
			NativeLib.LoadDeviceFunction("vkGetDeviceProcAddr",  out vkGetDeviceProcAddr_ptr);
			NativeLib.LoadFunction("vkCreateDevice",  out vkCreateDevice_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyDevice",  out vkDestroyDevice_ptr);
			...
			NativeLib.LoadDeviceFunction("vkGetDeviceQueue",  out vkGetDeviceQueue_ptr);
			NativeLib.LoadDeviceFunction("vkQueueSubmit",  out vkQueueSubmit_ptr);
			NativeLib.LoadDeviceFunction("vkQueueWaitIdle",  out vkQueueWaitIdle_ptr);
			NativeLib.LoadDeviceFunction("vkDeviceWaitIdle",  out vkDeviceWaitIdle_ptr);
			NativeLib.LoadDeviceFunction("vkAllocateMemory",  out vkAllocateMemory_ptr);
			NativeLib.LoadDeviceFunction("vkFreeMemory",  out vkFreeMemory_ptr);
			NativeLib.LoadDeviceFunction("vkMapMemory",  out vkMapMemory_ptr);
			NativeLib.LoadDeviceFunction("vkUnmapMemory",  out vkUnmapMemory_ptr);
			NativeLib.LoadDeviceFunction("vkFlushMappedMemoryRanges",  out vkFlushMappedMemoryRanges_ptr);
			NativeLib.LoadDeviceFunction("vkInvalidateMappedMemoryRanges",  out vkInvalidateMappedMemoryRanges_ptr);
			NativeLib.LoadDeviceFunction("vkGetDeviceMemoryCommitment",  out vkGetDeviceMemoryCommitment_ptr);
			NativeLib.LoadDeviceFunction("vkBindBufferMemory",  out vkBindBufferMemory_ptr);
			NativeLib.LoadDeviceFunction("vkBindImageMemory",  out vkBindImageMemory_ptr);
			NativeLib.LoadDeviceFunction("vkGetBufferMemoryRequirements",  out vkGetBufferMemoryRequirements_ptr);
			NativeLib.LoadDeviceFunction("vkGetImageMemoryRequirements",  out vkGetImageMemoryRequirements_ptr);
			NativeLib.LoadDeviceFunction("vkGetImageSparseMemoryRequirements",  out vkGetImageSparseMemoryRequirements_ptr);
			...
			NativeLib.LoadDeviceFunction("vkQueueBindSparse",  out vkQueueBindSparse_ptr);
			NativeLib.LoadDeviceFunction("vkCreateFence",  out vkCreateFence_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyFence",  out vkDestroyFence_ptr);
			NativeLib.LoadDeviceFunction("vkResetFences",  out vkResetFences_ptr);
			NativeLib.LoadDeviceFunction("vkGetFenceStatus",  out vkGetFenceStatus_ptr);
			NativeLib.LoadDeviceFunction("vkWaitForFences",  out vkWaitForFences_ptr);
			NativeLib.LoadDeviceFunction("vkCreateSemaphore",  out vkCreateSemaphore_ptr);
			NativeLib.LoadDeviceFunction("vkDestroySemaphore",  out vkDestroySemaphore_ptr);
			NativeLib.LoadDeviceFunction("vkCreateEvent",  out vkCreateEvent_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyEvent",  out vkDestroyEvent_ptr);
			NativeLib.LoadDeviceFunction("vkGetEventStatus",  out vkGetEventStatus_ptr);
			NativeLib.LoadDeviceFunction("vkSetEvent",  out vkSetEvent_ptr);
			NativeLib.LoadDeviceFunction("vkResetEvent",  out vkResetEvent_ptr);
			NativeLib.LoadDeviceFunction("vkCreateQueryPool",  out vkCreateQueryPool_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyQueryPool",  out vkDestroyQueryPool_ptr);
			NativeLib.LoadDeviceFunction("vkGetQueryPoolResults",  out vkGetQueryPoolResults_ptr);
			NativeLib.LoadDeviceFunction("vkCreateBuffer",  out vkCreateBuffer_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyBuffer",  out vkDestroyBuffer_ptr);
			NativeLib.LoadDeviceFunction("vkCreateBufferView",  out vkCreateBufferView_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyBufferView",  out vkDestroyBufferView_ptr);
			NativeLib.LoadDeviceFunction("vkCreateImage",  out vkCreateImage_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyImage",  out vkDestroyImage_ptr);
			NativeLib.LoadDeviceFunction("vkGetImageSubresourceLayout",  out vkGetImageSubresourceLayout_ptr);
			NativeLib.LoadDeviceFunction("vkCreateImageView",  out vkCreateImageView_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyImageView",  out vkDestroyImageView_ptr);
			NativeLib.LoadDeviceFunction("vkCreateShaderModule",  out vkCreateShaderModule_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyShaderModule",  out vkDestroyShaderModule_ptr);
			NativeLib.LoadDeviceFunction("vkCreatePipelineCache",  out vkCreatePipelineCache_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyPipelineCache",  out vkDestroyPipelineCache_ptr);
			NativeLib.LoadDeviceFunction("vkGetPipelineCacheData",  out vkGetPipelineCacheData_ptr);
			NativeLib.LoadDeviceFunction("vkMergePipelineCaches",  out vkMergePipelineCaches_ptr);
			NativeLib.LoadDeviceFunction("vkCreateGraphicsPipelines",  out vkCreateGraphicsPipelines_ptr);
			NativeLib.LoadDeviceFunction("vkCreateComputePipelines",  out vkCreateComputePipelines_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyPipeline",  out vkDestroyPipeline_ptr);
			NativeLib.LoadDeviceFunction("vkCreatePipelineLayout",  out vkCreatePipelineLayout_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyPipelineLayout",  out vkDestroyPipelineLayout_ptr);
			NativeLib.LoadDeviceFunction("vkCreateSampler",  out vkCreateSampler_ptr);
			NativeLib.LoadDeviceFunction("vkDestroySampler",  out vkDestroySampler_ptr);
			NativeLib.LoadDeviceFunction("vkCreateDescriptorSetLayout",  out vkCreateDescriptorSetLayout_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyDescriptorSetLayout",  out vkDestroyDescriptorSetLayout_ptr);
			NativeLib.LoadDeviceFunction("vkCreateDescriptorPool",  out vkCreateDescriptorPool_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyDescriptorPool",  out vkDestroyDescriptorPool_ptr);
			NativeLib.LoadDeviceFunction("vkResetDescriptorPool",  out vkResetDescriptorPool_ptr);
			NativeLib.LoadDeviceFunction("vkAllocateDescriptorSets",  out vkAllocateDescriptorSets_ptr);
			NativeLib.LoadDeviceFunction("vkFreeDescriptorSets",  out vkFreeDescriptorSets_ptr);
			NativeLib.LoadDeviceFunction("vkUpdateDescriptorSets",  out vkUpdateDescriptorSets_ptr);
			NativeLib.LoadDeviceFunction("vkCreateFramebuffer",  out vkCreateFramebuffer_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyFramebuffer",  out vkDestroyFramebuffer_ptr);
			NativeLib.LoadDeviceFunction("vkCreateRenderPass",  out vkCreateRenderPass_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyRenderPass",  out vkDestroyRenderPass_ptr);
			NativeLib.LoadDeviceFunction("vkGetRenderAreaGranularity",  out vkGetRenderAreaGranularity_ptr);
			NativeLib.LoadDeviceFunction("vkCreateCommandPool",  out vkCreateCommandPool_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyCommandPool",  out vkDestroyCommandPool_ptr);
			NativeLib.LoadDeviceFunction("vkResetCommandPool",  out vkResetCommandPool_ptr);
			NativeLib.LoadDeviceFunction("vkAllocateCommandBuffers",  out vkAllocateCommandBuffers_ptr);
			NativeLib.LoadDeviceFunction("vkFreeCommandBuffers",  out vkFreeCommandBuffers_ptr);
			NativeLib.LoadDeviceFunction("vkBeginCommandBuffer",  out vkBeginCommandBuffer_ptr);
			NativeLib.LoadDeviceFunction("vkEndCommandBuffer",  out vkEndCommandBuffer_ptr);
			NativeLib.LoadDeviceFunction("vkResetCommandBuffer",  out vkResetCommandBuffer_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBindPipeline",  out vkCmdBindPipeline_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetViewport",  out vkCmdSetViewport_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetScissor",  out vkCmdSetScissor_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetLineWidth",  out vkCmdSetLineWidth_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetDepthBias",  out vkCmdSetDepthBias_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetBlendConstants",  out vkCmdSetBlendConstants_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetDepthBounds",  out vkCmdSetDepthBounds_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetStencilCompareMask",  out vkCmdSetStencilCompareMask_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetStencilWriteMask",  out vkCmdSetStencilWriteMask_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetStencilReference",  out vkCmdSetStencilReference_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBindDescriptorSets",  out vkCmdBindDescriptorSets_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBindIndexBuffer",  out vkCmdBindIndexBuffer_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBindVertexBuffers",  out vkCmdBindVertexBuffers_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDraw",  out vkCmdDraw_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDrawIndexed",  out vkCmdDrawIndexed_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDrawIndirect",  out vkCmdDrawIndirect_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDrawIndexedIndirect",  out vkCmdDrawIndexedIndirect_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDispatch",  out vkCmdDispatch_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDispatchIndirect",  out vkCmdDispatchIndirect_ptr);
			NativeLib.LoadDeviceFunction("vkCmdCopyBuffer",  out vkCmdCopyBuffer_ptr);
			NativeLib.LoadDeviceFunction("vkCmdCopyImage",  out vkCmdCopyImage_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBlitImage",  out vkCmdBlitImage_ptr);
			NativeLib.LoadDeviceFunction("vkCmdCopyBufferToImage",  out vkCmdCopyBufferToImage_ptr);
			NativeLib.LoadDeviceFunction("vkCmdCopyImageToBuffer",  out vkCmdCopyImageToBuffer_ptr);
			NativeLib.LoadDeviceFunction("vkCmdUpdateBuffer",  out vkCmdUpdateBuffer_ptr);
			NativeLib.LoadDeviceFunction("vkCmdFillBuffer",  out vkCmdFillBuffer_ptr);
			NativeLib.LoadDeviceFunction("vkCmdClearColorImage",  out vkCmdClearColorImage_ptr);
			NativeLib.LoadDeviceFunction("vkCmdClearDepthStencilImage",  out vkCmdClearDepthStencilImage_ptr);
			NativeLib.LoadDeviceFunction("vkCmdClearAttachments",  out vkCmdClearAttachments_ptr);
			NativeLib.LoadDeviceFunction("vkCmdResolveImage",  out vkCmdResolveImage_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetEvent",  out vkCmdSetEvent_ptr);
			NativeLib.LoadDeviceFunction("vkCmdResetEvent",  out vkCmdResetEvent_ptr);
			NativeLib.LoadDeviceFunction("vkCmdWaitEvents",  out vkCmdWaitEvents_ptr);
			NativeLib.LoadDeviceFunction("vkCmdPipelineBarrier",  out vkCmdPipelineBarrier_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBeginQuery",  out vkCmdBeginQuery_ptr);
			NativeLib.LoadDeviceFunction("vkCmdEndQuery",  out vkCmdEndQuery_ptr);
			NativeLib.LoadDeviceFunction("vkCmdResetQueryPool",  out vkCmdResetQueryPool_ptr);
			NativeLib.LoadDeviceFunction("vkCmdWriteTimestamp",  out vkCmdWriteTimestamp_ptr);
			NativeLib.LoadDeviceFunction("vkCmdCopyQueryPoolResults",  out vkCmdCopyQueryPoolResults_ptr);
			NativeLib.LoadDeviceFunction("vkCmdPushConstants",  out vkCmdPushConstants_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBeginRenderPass",  out vkCmdBeginRenderPass_ptr);
			NativeLib.LoadDeviceFunction("vkCmdNextSubpass",  out vkCmdNextSubpass_ptr);
			NativeLib.LoadDeviceFunction("vkCmdEndRenderPass",  out vkCmdEndRenderPass_ptr);
			NativeLib.LoadDeviceFunction("vkCmdExecuteCommands",  out vkCmdExecuteCommands_ptr);
			NativeLib.LoadFunction("vkEnumerateInstanceVersion",  out vkEnumerateInstanceVersion_ptr);
			NativeLib.LoadDeviceFunction("vkBindBufferMemory2",  out vkBindBufferMemory2_ptr);
			NativeLib.LoadDeviceFunction("vkBindImageMemory2",  out vkBindImageMemory2_ptr);
			NativeLib.LoadDeviceFunction("vkGetDeviceGroupPeerMemoryFeatures",  out vkGetDeviceGroupPeerMemoryFeatures_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetDeviceMask",  out vkCmdSetDeviceMask_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDispatchBase",  out vkCmdDispatchBase_ptr);
			NativeLib.LoadFunction("vkEnumeratePhysicalDeviceGroups",  out vkEnumeratePhysicalDeviceGroups_ptr);
			NativeLib.LoadDeviceFunction("vkGetImageMemoryRequirements2",  out vkGetImageMemoryRequirements2_ptr);
			NativeLib.LoadDeviceFunction("vkGetBufferMemoryRequirements2",  out vkGetBufferMemoryRequirements2_ptr);
			NativeLib.LoadDeviceFunction("vkGetImageSparseMemoryRequirements2",  out vkGetImageSparseMemoryRequirements2_ptr);
			...
			NativeLib.LoadDeviceFunction("vkTrimCommandPool",  out vkTrimCommandPool_ptr);
			NativeLib.LoadDeviceFunction("vkGetDeviceQueue2",  out vkGetDeviceQueue2_ptr);
			NativeLib.LoadDeviceFunction("vkCreateSamplerYcbcrConversion",  out vkCreateSamplerYcbcrConversion_ptr);
			NativeLib.LoadDeviceFunction("vkDestroySamplerYcbcrConversion",  out vkDestroySamplerYcbcrConversion_ptr);
			NativeLib.LoadDeviceFunction("vkCreateDescriptorUpdateTemplate",  out vkCreateDescriptorUpdateTemplate_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyDescriptorUpdateTemplate",  out vkDestroyDescriptorUpdateTemplate_ptr);
			NativeLib.LoadDeviceFunction("vkUpdateDescriptorSetWithTemplate",  out vkUpdateDescriptorSetWithTemplate_ptr);
			...
			NativeLib.LoadDeviceFunction("vkGetDescriptorSetLayoutSupport",  out vkGetDescriptorSetLayoutSupport_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDrawIndirectCount",  out vkCmdDrawIndirectCount_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDrawIndexedIndirectCount",  out vkCmdDrawIndexedIndirectCount_ptr);
			NativeLib.LoadDeviceFunction("vkCreateRenderPass2",  out vkCreateRenderPass2_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBeginRenderPass2",  out vkCmdBeginRenderPass2_ptr);
			NativeLib.LoadDeviceFunction("vkCmdNextSubpass2",  out vkCmdNextSubpass2_ptr);
			NativeLib.LoadDeviceFunction("vkCmdEndRenderPass2",  out vkCmdEndRenderPass2_ptr);
			NativeLib.LoadDeviceFunction("vkResetQueryPool",  out vkResetQueryPool_ptr);
			NativeLib.LoadDeviceFunction("vkGetSemaphoreCounterValue",  out vkGetSemaphoreCounterValue_ptr);
			NativeLib.LoadDeviceFunction("vkWaitSemaphores",  out vkWaitSemaphores_ptr);
			NativeLib.LoadDeviceFunction("vkSignalSemaphore",  out vkSignalSemaphore_ptr);
			NativeLib.LoadDeviceFunction("vkGetBufferDeviceAddress",  out vkGetBufferDeviceAddress_ptr);
			NativeLib.LoadDeviceFunction("vkGetBufferOpaqueCaptureAddress",  out vkGetBufferOpaqueCaptureAddress_ptr);
			NativeLib.LoadDeviceFunction("vkGetDeviceMemoryOpaqueCaptureAddress",  out vkGetDeviceMemoryOpaqueCaptureAddress_ptr);
			NativeLib.LoadFunction("vkGetPhysicalDeviceToolProperties",  out vkGetPhysicalDeviceToolProperties_ptr);
			NativeLib.LoadDeviceFunction("vkCreatePrivateDataSlot",  out vkCreatePrivateDataSlot_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyPrivateDataSlot",  out vkDestroyPrivateDataSlot_ptr);
			NativeLib.LoadDeviceFunction("vkSetPrivateData",  out vkSetPrivateData_ptr);
			NativeLib.LoadDeviceFunction("vkGetPrivateData",  out vkGetPrivateData_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetEvent2",  out vkCmdSetEvent2_ptr);
			NativeLib.LoadDeviceFunction("vkCmdResetEvent2",  out vkCmdResetEvent2_ptr);
			NativeLib.LoadDeviceFunction("vkCmdWaitEvents2",  out vkCmdWaitEvents2_ptr);
			NativeLib.LoadDeviceFunction("vkCmdPipelineBarrier2",  out vkCmdPipelineBarrier2_ptr);
			NativeLib.LoadDeviceFunction("vkCmdWriteTimestamp2",  out vkCmdWriteTimestamp2_ptr);
			NativeLib.LoadDeviceFunction("vkQueueSubmit2",  out vkQueueSubmit2_ptr);
			NativeLib.LoadDeviceFunction("vkCmdCopyBuffer2",  out vkCmdCopyBuffer2_ptr);
			NativeLib.LoadDeviceFunction("vkCmdCopyImage2",  out vkCmdCopyImage2_ptr);
			NativeLib.LoadDeviceFunction("vkCmdCopyBufferToImage2",  out vkCmdCopyBufferToImage2_ptr);
			NativeLib.LoadDeviceFunction("vkCmdCopyImageToBuffer2",  out vkCmdCopyImageToBuffer2_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBlitImage2",  out vkCmdBlitImage2_ptr);
			NativeLib.LoadDeviceFunction("vkCmdResolveImage2",  out vkCmdResolveImage2_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBeginRendering",  out vkCmdBeginRendering_ptr);
			NativeLib.LoadDeviceFunction("vkCmdEndRendering",  out vkCmdEndRendering_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetCullMode",  out vkCmdSetCullMode_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetFrontFace",  out vkCmdSetFrontFace_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetPrimitiveTopology",  out vkCmdSetPrimitiveTopology_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetViewportWithCount",  out vkCmdSetViewportWithCount_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetScissorWithCount",  out vkCmdSetScissorWithCount_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBindVertexBuffers2",  out vkCmdBindVertexBuffers2_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetDepthTestEnable",  out vkCmdSetDepthTestEnable_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetDepthWriteEnable",  out vkCmdSetDepthWriteEnable_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetDepthCompareOp",  out vkCmdSetDepthCompareOp_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetDepthBoundsTestEnable",  out vkCmdSetDepthBoundsTestEnable_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetStencilTestEnable",  out vkCmdSetStencilTestEnable_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetStencilOp",  out vkCmdSetStencilOp_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetRasterizerDiscardEnable",  out vkCmdSetRasterizerDiscardEnable_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetDepthBiasEnable",  out vkCmdSetDepthBiasEnable_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetPrimitiveRestartEnable",  out vkCmdSetPrimitiveRestartEnable_ptr);
			NativeLib.LoadDeviceFunction("vkGetDeviceBufferMemoryRequirements",  out vkGetDeviceBufferMemoryRequirements_ptr);
			NativeLib.LoadDeviceFunction("vkGetDeviceImageMemoryRequirements",  out vkGetDeviceImageMemoryRequirements_ptr);
			NativeLib.LoadDeviceFunction("vkGetDeviceImageSparseMemoryRequirements",  out vkGetDeviceImageSparseMemoryRequirements_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetLineStipple",  out vkCmdSetLineStipple_ptr);
			NativeLib.LoadDeviceFunction("vkMapMemory2",  out vkMapMemory2_ptr);
			NativeLib.LoadDeviceFunction("vkUnmapMemory2",  out vkUnmapMemory2_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBindIndexBuffer2",  out vkCmdBindIndexBuffer2_ptr);
			NativeLib.LoadDeviceFunction("vkGetRenderingAreaGranularity",  out vkGetRenderingAreaGranularity_ptr);
			NativeLib.LoadDeviceFunction("vkGetDeviceImageSubresourceLayout",  out vkGetDeviceImageSubresourceLayout_ptr);
			NativeLib.LoadDeviceFunction("vkGetImageSubresourceLayout2",  out vkGetImageSubresourceLayout2_ptr);
			NativeLib.LoadDeviceFunction("vkCmdPushDescriptorSet",  out vkCmdPushDescriptorSet_ptr);
			NativeLib.LoadDeviceFunction("vkCmdPushDescriptorSetWithTemplate",  out vkCmdPushDescriptorSetWithTemplate_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetRenderingAttachmentLocations",  out vkCmdSetRenderingAttachmentLocations_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetRenderingInputAttachmentIndices",  out vkCmdSetRenderingInputAttachmentIndices_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBindDescriptorSets2",  out vkCmdBindDescriptorSets2_ptr);
			NativeLib.LoadDeviceFunction("vkCmdPushConstants2",  out vkCmdPushConstants2_ptr);
			NativeLib.LoadDeviceFunction("vkCmdPushDescriptorSet2",  out vkCmdPushDescriptorSet2_ptr);
			NativeLib.LoadDeviceFunction("vkCmdPushDescriptorSetWithTemplate2",  out vkCmdPushDescriptorSetWithTemplate2_ptr);
			NativeLib.LoadDeviceFunction("vkCopyMemoryToImage",  out vkCopyMemoryToImage_ptr);
			NativeLib.LoadDeviceFunction("vkCopyImageToMemory",  out vkCopyImageToMemory_ptr);
			NativeLib.LoadDeviceFunction("vkCopyImageToImage",  out vkCopyImageToImage_ptr);
			NativeLib.LoadDeviceFunction("vkTransitionImageLayout",  out vkTransitionImageLayout_ptr);
			NativeLib.LoadDeviceFunction("vkGetCommandPoolMemoryConsumption",  out vkGetCommandPoolMemoryConsumption_ptr);
			NativeLib.LoadDeviceFunction("vkGetFaultData",  out vkGetFaultData_ptr);
			...
			NativeLib.LoadDeviceFunction("vkCreateSwapchainKHR",  out vkCreateSwapchainKHR_ptr);
			NativeLib.LoadDeviceFunction("vkDestroySwapchainKHR",  out vkDestroySwapchainKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetSwapchainImagesKHR",  out vkGetSwapchainImagesKHR_ptr);
			NativeLib.LoadDeviceFunction("vkAcquireNextImageKHR",  out vkAcquireNextImageKHR_ptr);
			NativeLib.LoadDeviceFunction("vkQueuePresentKHR",  out vkQueuePresentKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetDeviceGroupPresentCapabilitiesKHR",  out vkGetDeviceGroupPresentCapabilitiesKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetDeviceGroupSurfacePresentModesKHR",  out vkGetDeviceGroupSurfacePresentModesKHR_ptr);
			NativeLib.LoadFunction("vkGetPhysicalDevicePresentRectanglesKHR",  out vkGetPhysicalDevicePresentRectanglesKHR_ptr);
			NativeLib.LoadDeviceFunction("vkAcquireNextImage2KHR",  out vkAcquireNextImage2KHR_ptr);
			...
			NativeLib.LoadDeviceFunction("vkCreateSharedSwapchainsKHR",  out vkCreateSharedSwapchainsKHR_ptr);
			...
			NativeLib.LoadDeviceFunction("vkDebugMarkerSetObjectTagEXT",  out vkDebugMarkerSetObjectTagEXT_ptr);
			NativeLib.LoadDeviceFunction("vkDebugMarkerSetObjectNameEXT",  out vkDebugMarkerSetObjectNameEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDebugMarkerBeginEXT",  out vkCmdDebugMarkerBeginEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDebugMarkerEndEXT",  out vkCmdDebugMarkerEndEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDebugMarkerInsertEXT",  out vkCmdDebugMarkerInsertEXT_ptr);
			...
			NativeLib.LoadDeviceFunction("vkCreateVideoSessionKHR",  out vkCreateVideoSessionKHR_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyVideoSessionKHR",  out vkDestroyVideoSessionKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetVideoSessionMemoryRequirementsKHR",  out vkGetVideoSessionMemoryRequirementsKHR_ptr);
			NativeLib.LoadDeviceFunction("vkBindVideoSessionMemoryKHR",  out vkBindVideoSessionMemoryKHR_ptr);
			NativeLib.LoadDeviceFunction("vkCreateVideoSessionParametersKHR",  out vkCreateVideoSessionParametersKHR_ptr);
			NativeLib.LoadDeviceFunction("vkUpdateVideoSessionParametersKHR",  out vkUpdateVideoSessionParametersKHR_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyVideoSessionParametersKHR",  out vkDestroyVideoSessionParametersKHR_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBeginVideoCodingKHR",  out vkCmdBeginVideoCodingKHR_ptr);
			NativeLib.LoadDeviceFunction("vkCmdEndVideoCodingKHR",  out vkCmdEndVideoCodingKHR_ptr);
			NativeLib.LoadDeviceFunction("vkCmdControlVideoCodingKHR",  out vkCmdControlVideoCodingKHR_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDecodeVideoKHR",  out vkCmdDecodeVideoKHR_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBindTransformFeedbackBuffersEXT",  out vkCmdBindTransformFeedbackBuffersEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBeginTransformFeedbackEXT",  out vkCmdBeginTransformFeedbackEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdEndTransformFeedbackEXT",  out vkCmdEndTransformFeedbackEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBeginQueryIndexedEXT",  out vkCmdBeginQueryIndexedEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdEndQueryIndexedEXT",  out vkCmdEndQueryIndexedEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDrawIndirectByteCountEXT",  out vkCmdDrawIndirectByteCountEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCreateCuModuleNVX",  out vkCreateCuModuleNVX_ptr);
			NativeLib.LoadDeviceFunction("vkCreateCuFunctionNVX",  out vkCreateCuFunctionNVX_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyCuModuleNVX",  out vkDestroyCuModuleNVX_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyCuFunctionNVX",  out vkDestroyCuFunctionNVX_ptr);
			NativeLib.LoadDeviceFunction("vkCmdCuLaunchKernelNVX",  out vkCmdCuLaunchKernelNVX_ptr);
			NativeLib.LoadDeviceFunction("vkGetImageViewHandleNVX",  out vkGetImageViewHandleNVX_ptr);
			NativeLib.LoadDeviceFunction("vkGetImageViewHandle64NVX",  out vkGetImageViewHandle64NVX_ptr);
			NativeLib.LoadDeviceFunction("vkGetImageViewAddressNVX",  out vkGetImageViewAddressNVX_ptr);
			NativeLib.LoadDeviceFunction("vkGetShaderInfoAMD",  out vkGetShaderInfoAMD_ptr);
			...
			NativeLib.LoadDeviceFunction("vkGetMemoryWin32HandleNV",  out vkGetMemoryWin32HandleNV_ptr);
			NativeLib.LoadFunction("vkCreateViSurfaceNN",  out vkCreateViSurfaceNN_ptr);
			NativeLib.LoadDeviceFunction("vkGetMemoryWin32HandleKHR",  out vkGetMemoryWin32HandleKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetMemoryWin32HandlePropertiesKHR",  out vkGetMemoryWin32HandlePropertiesKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetMemoryFdKHR",  out vkGetMemoryFdKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetMemoryFdPropertiesKHR",  out vkGetMemoryFdPropertiesKHR_ptr);
			NativeLib.LoadDeviceFunction("vkImportSemaphoreWin32HandleKHR",  out vkImportSemaphoreWin32HandleKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetSemaphoreWin32HandleKHR",  out vkGetSemaphoreWin32HandleKHR_ptr);
			NativeLib.LoadDeviceFunction("vkImportSemaphoreFdKHR",  out vkImportSemaphoreFdKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetSemaphoreFdKHR",  out vkGetSemaphoreFdKHR_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBeginConditionalRenderingEXT",  out vkCmdBeginConditionalRenderingEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdEndConditionalRenderingEXT",  out vkCmdEndConditionalRenderingEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetViewportWScalingNV",  out vkCmdSetViewportWScalingNV_ptr);
			...
			NativeLib.LoadDeviceFunction("vkDisplayPowerControlEXT",  out vkDisplayPowerControlEXT_ptr);
			NativeLib.LoadDeviceFunction("vkRegisterDeviceEventEXT",  out vkRegisterDeviceEventEXT_ptr);
			NativeLib.LoadDeviceFunction("vkRegisterDisplayEventEXT",  out vkRegisterDisplayEventEXT_ptr);
			NativeLib.LoadDeviceFunction("vkGetSwapchainCounterEXT",  out vkGetSwapchainCounterEXT_ptr);
			NativeLib.LoadDeviceFunction("vkGetRefreshCycleDurationGOOGLE",  out vkGetRefreshCycleDurationGOOGLE_ptr);
			NativeLib.LoadDeviceFunction("vkGetPastPresentationTimingGOOGLE",  out vkGetPastPresentationTimingGOOGLE_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetDiscardRectangleEXT",  out vkCmdSetDiscardRectangleEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetDiscardRectangleEnableEXT",  out vkCmdSetDiscardRectangleEnableEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetDiscardRectangleModeEXT",  out vkCmdSetDiscardRectangleModeEXT_ptr);
			NativeLib.LoadDeviceFunction("vkSetHdrMetadataEXT",  out vkSetHdrMetadataEXT_ptr);
			NativeLib.LoadDeviceFunction("vkGetSwapchainStatusKHR",  out vkGetSwapchainStatusKHR_ptr);
			NativeLib.LoadDeviceFunction("vkImportFenceWin32HandleKHR",  out vkImportFenceWin32HandleKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetFenceWin32HandleKHR",  out vkGetFenceWin32HandleKHR_ptr);
			NativeLib.LoadDeviceFunction("vkImportFenceFdKHR",  out vkImportFenceFdKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetFenceFdKHR",  out vkGetFenceFdKHR_ptr);
			...
			NativeLib.LoadDeviceFunction("vkAcquireProfilingLockKHR",  out vkAcquireProfilingLockKHR_ptr);
			NativeLib.LoadDeviceFunction("vkReleaseProfilingLockKHR",  out vkReleaseProfilingLockKHR_ptr);
			...
			NativeLib.LoadDeviceFunction("vkSetDebugUtilsObjectNameEXT",  out vkSetDebugUtilsObjectNameEXT_ptr);
			NativeLib.LoadDeviceFunction("vkSetDebugUtilsObjectTagEXT",  out vkSetDebugUtilsObjectTagEXT_ptr);
			NativeLib.LoadDeviceFunction("vkQueueBeginDebugUtilsLabelEXT",  out vkQueueBeginDebugUtilsLabelEXT_ptr);
			NativeLib.LoadDeviceFunction("vkQueueEndDebugUtilsLabelEXT",  out vkQueueEndDebugUtilsLabelEXT_ptr);
			NativeLib.LoadDeviceFunction("vkQueueInsertDebugUtilsLabelEXT",  out vkQueueInsertDebugUtilsLabelEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBeginDebugUtilsLabelEXT",  out vkCmdBeginDebugUtilsLabelEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdEndDebugUtilsLabelEXT",  out vkCmdEndDebugUtilsLabelEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdInsertDebugUtilsLabelEXT",  out vkCmdInsertDebugUtilsLabelEXT_ptr);
			...
			NativeLib.LoadDeviceFunction("vkGetAndroidHardwareBufferPropertiesANDROID",  out vkGetAndroidHardwareBufferPropertiesANDROID_ptr);
			NativeLib.LoadDeviceFunction("vkGetMemoryAndroidHardwareBufferANDROID",  out vkGetMemoryAndroidHardwareBufferANDROID_ptr);
			NativeLib.LoadDeviceFunction("vkCreateExecutionGraphPipelinesAMDX",  out vkCreateExecutionGraphPipelinesAMDX_ptr);
			NativeLib.LoadDeviceFunction("vkGetExecutionGraphPipelineScratchSizeAMDX",  out vkGetExecutionGraphPipelineScratchSizeAMDX_ptr);
			NativeLib.LoadDeviceFunction("vkGetExecutionGraphPipelineNodeIndexAMDX",  out vkGetExecutionGraphPipelineNodeIndexAMDX_ptr);
			NativeLib.LoadDeviceFunction("vkCmdInitializeGraphScratchMemoryAMDX",  out vkCmdInitializeGraphScratchMemoryAMDX_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDispatchGraphAMDX",  out vkCmdDispatchGraphAMDX_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDispatchGraphIndirectAMDX",  out vkCmdDispatchGraphIndirectAMDX_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDispatchGraphIndirectCountAMDX",  out vkCmdDispatchGraphIndirectCountAMDX_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetSampleLocationsEXT",  out vkCmdSetSampleLocationsEXT_ptr);
			NativeLib.LoadFunction("vkGetPhysicalDeviceMultisamplePropertiesEXT",  out vkGetPhysicalDeviceMultisamplePropertiesEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCreateAccelerationStructureKHR",  out vkCreateAccelerationStructureKHR_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyAccelerationStructureKHR",  out vkDestroyAccelerationStructureKHR_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBuildAccelerationStructuresKHR",  out vkCmdBuildAccelerationStructuresKHR_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBuildAccelerationStructuresIndirectKHR",  out vkCmdBuildAccelerationStructuresIndirectKHR_ptr);
			NativeLib.LoadDeviceFunction("vkBuildAccelerationStructuresKHR",  out vkBuildAccelerationStructuresKHR_ptr);
			NativeLib.LoadDeviceFunction("vkCopyAccelerationStructureKHR",  out vkCopyAccelerationStructureKHR_ptr);
			NativeLib.LoadDeviceFunction("vkCopyAccelerationStructureToMemoryKHR",  out vkCopyAccelerationStructureToMemoryKHR_ptr);
			NativeLib.LoadDeviceFunction("vkCopyMemoryToAccelerationStructureKHR",  out vkCopyMemoryToAccelerationStructureKHR_ptr);
			NativeLib.LoadDeviceFunction("vkWriteAccelerationStructuresPropertiesKHR",  out vkWriteAccelerationStructuresPropertiesKHR_ptr);
			NativeLib.LoadDeviceFunction("vkCmdCopyAccelerationStructureKHR",  out vkCmdCopyAccelerationStructureKHR_ptr);
			NativeLib.LoadDeviceFunction("vkCmdCopyAccelerationStructureToMemoryKHR",  out vkCmdCopyAccelerationStructureToMemoryKHR_ptr);
			NativeLib.LoadDeviceFunction("vkCmdCopyMemoryToAccelerationStructureKHR",  out vkCmdCopyMemoryToAccelerationStructureKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetAccelerationStructureDeviceAddressKHR",  out vkGetAccelerationStructureDeviceAddressKHR_ptr);
			NativeLib.LoadDeviceFunction("vkCmdWriteAccelerationStructuresPropertiesKHR",  out vkCmdWriteAccelerationStructuresPropertiesKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetDeviceAccelerationStructureCompatibilityKHR",  out vkGetDeviceAccelerationStructureCompatibilityKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetAccelerationStructureBuildSizesKHR",  out vkGetAccelerationStructureBuildSizesKHR_ptr);
			NativeLib.LoadDeviceFunction("vkCmdTraceRaysKHR",  out vkCmdTraceRaysKHR_ptr);
			NativeLib.LoadDeviceFunction("vkCreateRayTracingPipelinesKHR",  out vkCreateRayTracingPipelinesKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetRayTracingShaderGroupHandlesKHR",  out vkGetRayTracingShaderGroupHandlesKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetRayTracingCaptureReplayShaderGroupHandlesKHR",  out vkGetRayTracingCaptureReplayShaderGroupHandlesKHR_ptr);
			NativeLib.LoadDeviceFunction("vkCmdTraceRaysIndirectKHR",  out vkCmdTraceRaysIndirectKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetRayTracingShaderGroupStackSizeKHR",  out vkGetRayTracingShaderGroupStackSizeKHR_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetRayTracingPipelineStackSizeKHR",  out vkCmdSetRayTracingPipelineStackSizeKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetImageDrmFormatModifierPropertiesEXT",  out vkGetImageDrmFormatModifierPropertiesEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCreateValidationCacheEXT",  out vkCreateValidationCacheEXT_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyValidationCacheEXT",  out vkDestroyValidationCacheEXT_ptr);
			NativeLib.LoadDeviceFunction("vkMergeValidationCachesEXT",  out vkMergeValidationCachesEXT_ptr);
			NativeLib.LoadDeviceFunction("vkGetValidationCacheDataEXT",  out vkGetValidationCacheDataEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBindShadingRateImageNV",  out vkCmdBindShadingRateImageNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetViewportShadingRatePaletteNV",  out vkCmdSetViewportShadingRatePaletteNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetCoarseSampleOrderNV",  out vkCmdSetCoarseSampleOrderNV_ptr);
			NativeLib.LoadDeviceFunction("vkCreateAccelerationStructureNV",  out vkCreateAccelerationStructureNV_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyAccelerationStructureNV",  out vkDestroyAccelerationStructureNV_ptr);
			NativeLib.LoadDeviceFunction("vkGetAccelerationStructureMemoryRequirementsNV",  out vkGetAccelerationStructureMemoryRequirementsNV_ptr);
			NativeLib.LoadDeviceFunction("vkBindAccelerationStructureMemoryNV",  out vkBindAccelerationStructureMemoryNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBuildAccelerationStructureNV",  out vkCmdBuildAccelerationStructureNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdCopyAccelerationStructureNV",  out vkCmdCopyAccelerationStructureNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdTraceRaysNV",  out vkCmdTraceRaysNV_ptr);
			NativeLib.LoadDeviceFunction("vkCreateRayTracingPipelinesNV",  out vkCreateRayTracingPipelinesNV_ptr);
			NativeLib.LoadDeviceFunction("vkGetAccelerationStructureHandleNV",  out vkGetAccelerationStructureHandleNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdWriteAccelerationStructuresPropertiesNV",  out vkCmdWriteAccelerationStructuresPropertiesNV_ptr);
			NativeLib.LoadDeviceFunction("vkCompileDeferredNV",  out vkCompileDeferredNV_ptr);
			NativeLib.LoadDeviceFunction("vkGetMemoryHostPointerPropertiesEXT",  out vkGetMemoryHostPointerPropertiesEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdWriteBufferMarkerAMD",  out vkCmdWriteBufferMarkerAMD_ptr);
			NativeLib.LoadDeviceFunction("vkCmdWriteBufferMarker2AMD",  out vkCmdWriteBufferMarker2AMD_ptr);
			...
			NativeLib.LoadDeviceFunction("vkGetCalibratedTimestampsKHR",  out vkGetCalibratedTimestampsKHR_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDrawMeshTasksNV",  out vkCmdDrawMeshTasksNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDrawMeshTasksIndirectNV",  out vkCmdDrawMeshTasksIndirectNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDrawMeshTasksIndirectCountNV",  out vkCmdDrawMeshTasksIndirectCountNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetExclusiveScissorEnableNV",  out vkCmdSetExclusiveScissorEnableNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetExclusiveScissorNV",  out vkCmdSetExclusiveScissorNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetCheckpointNV",  out vkCmdSetCheckpointNV_ptr);
			NativeLib.LoadDeviceFunction("vkGetQueueCheckpointDataNV",  out vkGetQueueCheckpointDataNV_ptr);
			NativeLib.LoadDeviceFunction("vkGetQueueCheckpointData2NV",  out vkGetQueueCheckpointData2NV_ptr);
			NativeLib.LoadDeviceFunction("vkInitializePerformanceApiINTEL",  out vkInitializePerformanceApiINTEL_ptr);
			NativeLib.LoadDeviceFunction("vkUninitializePerformanceApiINTEL",  out vkUninitializePerformanceApiINTEL_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetPerformanceMarkerINTEL",  out vkCmdSetPerformanceMarkerINTEL_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetPerformanceStreamMarkerINTEL",  out vkCmdSetPerformanceStreamMarkerINTEL_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetPerformanceOverrideINTEL",  out vkCmdSetPerformanceOverrideINTEL_ptr);
			NativeLib.LoadDeviceFunction("vkAcquirePerformanceConfigurationINTEL",  out vkAcquirePerformanceConfigurationINTEL_ptr);
			NativeLib.LoadDeviceFunction("vkReleasePerformanceConfigurationINTEL",  out vkReleasePerformanceConfigurationINTEL_ptr);
			NativeLib.LoadDeviceFunction("vkQueueSetPerformanceConfigurationINTEL",  out vkQueueSetPerformanceConfigurationINTEL_ptr);
			NativeLib.LoadDeviceFunction("vkGetPerformanceParameterINTEL",  out vkGetPerformanceParameterINTEL_ptr);
			NativeLib.LoadDeviceFunction("vkSetLocalDimmingAMD",  out vkSetLocalDimmingAMD_ptr);
			...
			NativeLib.LoadDeviceFunction("vkCmdSetFragmentShadingRateKHR",  out vkCmdSetFragmentShadingRateKHR_ptr);
			NativeLib.LoadDeviceFunction("vkWaitForPresentKHR",  out vkWaitForPresentKHR_ptr);
			...
			NativeLib.LoadDeviceFunction("vkAcquireFullScreenExclusiveModeEXT",  out vkAcquireFullScreenExclusiveModeEXT_ptr);
			NativeLib.LoadDeviceFunction("vkReleaseFullScreenExclusiveModeEXT",  out vkReleaseFullScreenExclusiveModeEXT_ptr);
			NativeLib.LoadDeviceFunction("vkGetDeviceGroupSurfacePresentModes2EXT",  out vkGetDeviceGroupSurfacePresentModes2EXT_ptr);
			NativeLib.LoadFunction("vkCreateHeadlessSurfaceEXT",  out vkCreateHeadlessSurfaceEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCreateDeferredOperationKHR",  out vkCreateDeferredOperationKHR_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyDeferredOperationKHR",  out vkDestroyDeferredOperationKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetDeferredOperationMaxConcurrencyKHR",  out vkGetDeferredOperationMaxConcurrencyKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetDeferredOperationResultKHR",  out vkGetDeferredOperationResultKHR_ptr);
			NativeLib.LoadDeviceFunction("vkDeferredOperationJoinKHR",  out vkDeferredOperationJoinKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetPipelineExecutablePropertiesKHR",  out vkGetPipelineExecutablePropertiesKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetPipelineExecutableStatisticsKHR",  out vkGetPipelineExecutableStatisticsKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetPipelineExecutableInternalRepresentationsKHR",  out vkGetPipelineExecutableInternalRepresentationsKHR_ptr);
			NativeLib.LoadDeviceFunction("vkReleaseSwapchainImagesEXT",  out vkReleaseSwapchainImagesEXT_ptr);
			NativeLib.LoadDeviceFunction("vkGetGeneratedCommandsMemoryRequirementsNV",  out vkGetGeneratedCommandsMemoryRequirementsNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdPreprocessGeneratedCommandsNV",  out vkCmdPreprocessGeneratedCommandsNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdExecuteGeneratedCommandsNV",  out vkCmdExecuteGeneratedCommandsNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBindPipelineShaderGroupNV",  out vkCmdBindPipelineShaderGroupNV_ptr);
			NativeLib.LoadDeviceFunction("vkCreateIndirectCommandsLayoutNV",  out vkCreateIndirectCommandsLayoutNV_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyIndirectCommandsLayoutNV",  out vkDestroyIndirectCommandsLayoutNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetDepthBias2EXT",  out vkCmdSetDepthBias2EXT_ptr);
			...
			NativeLib.LoadDeviceFunction("vkGetEncodedVideoSessionParametersKHR",  out vkGetEncodedVideoSessionParametersKHR_ptr);
			NativeLib.LoadDeviceFunction("vkCmdEncodeVideoKHR",  out vkCmdEncodeVideoKHR_ptr);
			NativeLib.LoadDeviceFunction("vkCreateCudaModuleNV",  out vkCreateCudaModuleNV_ptr);
			NativeLib.LoadDeviceFunction("vkGetCudaModuleCacheNV",  out vkGetCudaModuleCacheNV_ptr);
			NativeLib.LoadDeviceFunction("vkCreateCudaFunctionNV",  out vkCreateCudaFunctionNV_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyCudaModuleNV",  out vkDestroyCudaModuleNV_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyCudaFunctionNV",  out vkDestroyCudaFunctionNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdCudaLaunchKernelNV",  out vkCmdCudaLaunchKernelNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdRefreshObjectsKHR",  out vkCmdRefreshObjectsKHR_ptr);
			NativeLib.LoadFunction("vkGetPhysicalDeviceRefreshableObjectTypesKHR",  out vkGetPhysicalDeviceRefreshableObjectTypesKHR_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDispatchTileQCOM",  out vkCmdDispatchTileQCOM_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBeginPerTileExecutionQCOM",  out vkCmdBeginPerTileExecutionQCOM_ptr);
			NativeLib.LoadDeviceFunction("vkCmdEndPerTileExecutionQCOM",  out vkCmdEndPerTileExecutionQCOM_ptr);
			NativeLib.LoadDeviceFunction("vkExportMetalObjectsEXT",  out vkExportMetalObjectsEXT_ptr);
			NativeLib.LoadDeviceFunction("vkGetDescriptorSetLayoutSizeEXT",  out vkGetDescriptorSetLayoutSizeEXT_ptr);
			NativeLib.LoadDeviceFunction("vkGetDescriptorSetLayoutBindingOffsetEXT",  out vkGetDescriptorSetLayoutBindingOffsetEXT_ptr);
			NativeLib.LoadDeviceFunction("vkGetDescriptorEXT",  out vkGetDescriptorEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBindDescriptorBuffersEXT",  out vkCmdBindDescriptorBuffersEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetDescriptorBufferOffsetsEXT",  out vkCmdSetDescriptorBufferOffsetsEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBindDescriptorBufferEmbeddedSamplersEXT",  out vkCmdBindDescriptorBufferEmbeddedSamplersEXT_ptr);
			NativeLib.LoadDeviceFunction("vkGetBufferOpaqueCaptureDescriptorDataEXT",  out vkGetBufferOpaqueCaptureDescriptorDataEXT_ptr);
			NativeLib.LoadDeviceFunction("vkGetImageOpaqueCaptureDescriptorDataEXT",  out vkGetImageOpaqueCaptureDescriptorDataEXT_ptr);
			NativeLib.LoadDeviceFunction("vkGetImageViewOpaqueCaptureDescriptorDataEXT",  out vkGetImageViewOpaqueCaptureDescriptorDataEXT_ptr);
			NativeLib.LoadDeviceFunction("vkGetSamplerOpaqueCaptureDescriptorDataEXT",  out vkGetSamplerOpaqueCaptureDescriptorDataEXT_ptr);
			NativeLib.LoadDeviceFunction("vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXT",  out vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetFragmentShadingRateEnumNV",  out vkCmdSetFragmentShadingRateEnumNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDrawMeshTasksEXT",  out vkCmdDrawMeshTasksEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDrawMeshTasksIndirectEXT",  out vkCmdDrawMeshTasksIndirectEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDrawMeshTasksIndirectCountEXT",  out vkCmdDrawMeshTasksIndirectCountEXT_ptr);
			NativeLib.LoadDeviceFunction("vkGetDeviceFaultInfoEXT",  out vkGetDeviceFaultInfoEXT_ptr);
			...
			NativeLib.LoadDeviceFunction("vkCmdSetVertexInputEXT",  out vkCmdSetVertexInputEXT_ptr);
			NativeLib.LoadDeviceFunction("vkGetMemoryZirconHandleFUCHSIA",  out vkGetMemoryZirconHandleFUCHSIA_ptr);
			NativeLib.LoadDeviceFunction("vkGetMemoryZirconHandlePropertiesFUCHSIA",  out vkGetMemoryZirconHandlePropertiesFUCHSIA_ptr);
			NativeLib.LoadDeviceFunction("vkImportSemaphoreZirconHandleFUCHSIA",  out vkImportSemaphoreZirconHandleFUCHSIA_ptr);
			NativeLib.LoadDeviceFunction("vkGetSemaphoreZirconHandleFUCHSIA",  out vkGetSemaphoreZirconHandleFUCHSIA_ptr);
			NativeLib.LoadDeviceFunction("vkCreateBufferCollectionFUCHSIA",  out vkCreateBufferCollectionFUCHSIA_ptr);
			NativeLib.LoadDeviceFunction("vkSetBufferCollectionImageConstraintsFUCHSIA",  out vkSetBufferCollectionImageConstraintsFUCHSIA_ptr);
			NativeLib.LoadDeviceFunction("vkSetBufferCollectionBufferConstraintsFUCHSIA",  out vkSetBufferCollectionBufferConstraintsFUCHSIA_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyBufferCollectionFUCHSIA",  out vkDestroyBufferCollectionFUCHSIA_ptr);
			NativeLib.LoadDeviceFunction("vkGetBufferCollectionPropertiesFUCHSIA",  out vkGetBufferCollectionPropertiesFUCHSIA_ptr);
			NativeLib.LoadDeviceFunction("vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI",  out vkGetDeviceSubpassShadingMaxWorkgroupSizeHUAWEI_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSubpassShadingHUAWEI",  out vkCmdSubpassShadingHUAWEI_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBindInvocationMaskHUAWEI",  out vkCmdBindInvocationMaskHUAWEI_ptr);
			NativeLib.LoadDeviceFunction("vkGetMemoryRemoteAddressNV",  out vkGetMemoryRemoteAddressNV_ptr);
			NativeLib.LoadDeviceFunction("vkGetPipelinePropertiesEXT",  out vkGetPipelinePropertiesEXT_ptr);
			NativeLib.LoadDeviceFunction("vkGetFenceSciSyncFenceNV",  out vkGetFenceSciSyncFenceNV_ptr);
			NativeLib.LoadDeviceFunction("vkGetFenceSciSyncObjNV",  out vkGetFenceSciSyncObjNV_ptr);
			NativeLib.LoadDeviceFunction("vkImportFenceSciSyncFenceNV",  out vkImportFenceSciSyncFenceNV_ptr);
			NativeLib.LoadDeviceFunction("vkImportFenceSciSyncObjNV",  out vkImportFenceSciSyncObjNV_ptr);
			NativeLib.LoadFunction("vkGetPhysicalDeviceSciSyncAttributesNV",  out vkGetPhysicalDeviceSciSyncAttributesNV_ptr);
			NativeLib.LoadDeviceFunction("vkGetSemaphoreSciSyncObjNV",  out vkGetSemaphoreSciSyncObjNV_ptr);
			NativeLib.LoadDeviceFunction("vkImportSemaphoreSciSyncObjNV",  out vkImportSemaphoreSciSyncObjNV_ptr);
			NativeLib.LoadDeviceFunction("vkGetMemorySciBufNV",  out vkGetMemorySciBufNV_ptr);
			...
			NativeLib.LoadDeviceFunction("vkCmdSetPatchControlPointsEXT",  out vkCmdSetPatchControlPointsEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetLogicOpEXT",  out vkCmdSetLogicOpEXT_ptr);
			...
			NativeLib.LoadDeviceFunction("vkCmdSetColorWriteEnableEXT",  out vkCmdSetColorWriteEnableEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdTraceRaysIndirect2KHR",  out vkCmdTraceRaysIndirect2KHR_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDrawMultiEXT",  out vkCmdDrawMultiEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDrawMultiIndexedEXT",  out vkCmdDrawMultiIndexedEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCreateMicromapEXT",  out vkCreateMicromapEXT_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyMicromapEXT",  out vkDestroyMicromapEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBuildMicromapsEXT",  out vkCmdBuildMicromapsEXT_ptr);
			NativeLib.LoadDeviceFunction("vkBuildMicromapsEXT",  out vkBuildMicromapsEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCopyMicromapEXT",  out vkCopyMicromapEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCopyMicromapToMemoryEXT",  out vkCopyMicromapToMemoryEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCopyMemoryToMicromapEXT",  out vkCopyMemoryToMicromapEXT_ptr);
			NativeLib.LoadDeviceFunction("vkWriteMicromapsPropertiesEXT",  out vkWriteMicromapsPropertiesEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdCopyMicromapEXT",  out vkCmdCopyMicromapEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdCopyMicromapToMemoryEXT",  out vkCmdCopyMicromapToMemoryEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdCopyMemoryToMicromapEXT",  out vkCmdCopyMemoryToMicromapEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdWriteMicromapsPropertiesEXT",  out vkCmdWriteMicromapsPropertiesEXT_ptr);
			NativeLib.LoadDeviceFunction("vkGetDeviceMicromapCompatibilityEXT",  out vkGetDeviceMicromapCompatibilityEXT_ptr);
			NativeLib.LoadDeviceFunction("vkGetMicromapBuildSizesEXT",  out vkGetMicromapBuildSizesEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDrawClusterHUAWEI",  out vkCmdDrawClusterHUAWEI_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDrawClusterIndirectHUAWEI",  out vkCmdDrawClusterIndirectHUAWEI_ptr);
			NativeLib.LoadDeviceFunction("vkSetDeviceMemoryPriorityEXT",  out vkSetDeviceMemoryPriorityEXT_ptr);
			NativeLib.LoadDeviceFunction("vkGetDescriptorSetLayoutHostMappingInfoVALVE",  out vkGetDescriptorSetLayoutHostMappingInfoVALVE_ptr);
			NativeLib.LoadDeviceFunction("vkGetDescriptorSetHostMappingVALVE",  out vkGetDescriptorSetHostMappingVALVE_ptr);
			NativeLib.LoadDeviceFunction("vkCmdCopyMemoryIndirectNV",  out vkCmdCopyMemoryIndirectNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdCopyMemoryToImageIndirectNV",  out vkCmdCopyMemoryToImageIndirectNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDecompressMemoryNV",  out vkCmdDecompressMemoryNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdDecompressMemoryIndirectCountNV",  out vkCmdDecompressMemoryIndirectCountNV_ptr);
			NativeLib.LoadDeviceFunction("vkGetPipelineIndirectMemoryRequirementsNV",  out vkGetPipelineIndirectMemoryRequirementsNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdUpdatePipelineIndirectBufferNV",  out vkCmdUpdatePipelineIndirectBufferNV_ptr);
			NativeLib.LoadDeviceFunction("vkGetPipelineIndirectDeviceAddressNV",  out vkGetPipelineIndirectDeviceAddressNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetDepthClampEnableEXT",  out vkCmdSetDepthClampEnableEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetPolygonModeEXT",  out vkCmdSetPolygonModeEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetRasterizationSamplesEXT",  out vkCmdSetRasterizationSamplesEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetSampleMaskEXT",  out vkCmdSetSampleMaskEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetAlphaToCoverageEnableEXT",  out vkCmdSetAlphaToCoverageEnableEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetAlphaToOneEnableEXT",  out vkCmdSetAlphaToOneEnableEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetLogicOpEnableEXT",  out vkCmdSetLogicOpEnableEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetColorBlendEnableEXT",  out vkCmdSetColorBlendEnableEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetColorBlendEquationEXT",  out vkCmdSetColorBlendEquationEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetColorWriteMaskEXT",  out vkCmdSetColorWriteMaskEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetTessellationDomainOriginEXT",  out vkCmdSetTessellationDomainOriginEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetRasterizationStreamEXT",  out vkCmdSetRasterizationStreamEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetConservativeRasterizationModeEXT",  out vkCmdSetConservativeRasterizationModeEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetExtraPrimitiveOverestimationSizeEXT",  out vkCmdSetExtraPrimitiveOverestimationSizeEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetDepthClipEnableEXT",  out vkCmdSetDepthClipEnableEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetSampleLocationsEnableEXT",  out vkCmdSetSampleLocationsEnableEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetColorBlendAdvancedEXT",  out vkCmdSetColorBlendAdvancedEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetProvokingVertexModeEXT",  out vkCmdSetProvokingVertexModeEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetLineRasterizationModeEXT",  out vkCmdSetLineRasterizationModeEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetLineStippleEnableEXT",  out vkCmdSetLineStippleEnableEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetDepthClipNegativeOneToOneEXT",  out vkCmdSetDepthClipNegativeOneToOneEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetViewportWScalingEnableNV",  out vkCmdSetViewportWScalingEnableNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetViewportSwizzleNV",  out vkCmdSetViewportSwizzleNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetCoverageToColorEnableNV",  out vkCmdSetCoverageToColorEnableNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetCoverageToColorLocationNV",  out vkCmdSetCoverageToColorLocationNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetCoverageModulationModeNV",  out vkCmdSetCoverageModulationModeNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetCoverageModulationTableEnableNV",  out vkCmdSetCoverageModulationTableEnableNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetCoverageModulationTableNV",  out vkCmdSetCoverageModulationTableNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetShadingRateImageEnableNV",  out vkCmdSetShadingRateImageEnableNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetRepresentativeFragmentTestEnableNV",  out vkCmdSetRepresentativeFragmentTestEnableNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetCoverageReductionModeNV",  out vkCmdSetCoverageReductionModeNV_ptr);
			NativeLib.LoadDeviceFunction("vkGetShaderModuleIdentifierEXT",  out vkGetShaderModuleIdentifierEXT_ptr);
			NativeLib.LoadDeviceFunction("vkGetShaderModuleCreateInfoIdentifierEXT",  out vkGetShaderModuleCreateInfoIdentifierEXT_ptr);
			NativeLib.LoadFunction("vkGetPhysicalDeviceOpticalFlowImageFormatsNV",  out vkGetPhysicalDeviceOpticalFlowImageFormatsNV_ptr);
			NativeLib.LoadDeviceFunction("vkCreateOpticalFlowSessionNV",  out vkCreateOpticalFlowSessionNV_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyOpticalFlowSessionNV",  out vkDestroyOpticalFlowSessionNV_ptr);
			NativeLib.LoadDeviceFunction("vkBindOpticalFlowSessionImageNV",  out vkBindOpticalFlowSessionImageNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdOpticalFlowExecuteNV",  out vkCmdOpticalFlowExecuteNV_ptr);
			NativeLib.LoadDeviceFunction("vkAntiLagUpdateAMD",  out vkAntiLagUpdateAMD_ptr);
			NativeLib.LoadDeviceFunction("vkCreateShadersEXT",  out vkCreateShadersEXT_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyShaderEXT",  out vkDestroyShaderEXT_ptr);
			NativeLib.LoadDeviceFunction("vkGetShaderBinaryDataEXT",  out vkGetShaderBinaryDataEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBindShadersEXT",  out vkCmdBindShadersEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetDepthClampRangeEXT",  out vkCmdSetDepthClampRangeEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCreatePipelineBinariesKHR",  out vkCreatePipelineBinariesKHR_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyPipelineBinaryKHR",  out vkDestroyPipelineBinaryKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetPipelineKeyKHR",  out vkGetPipelineKeyKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetPipelineBinaryDataKHR",  out vkGetPipelineBinaryDataKHR_ptr);
			NativeLib.LoadDeviceFunction("vkReleaseCapturedPipelineDataKHR",  out vkReleaseCapturedPipelineDataKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetFramebufferTilePropertiesQCOM",  out vkGetFramebufferTilePropertiesQCOM_ptr);
			NativeLib.LoadDeviceFunction("vkGetDynamicRenderingTilePropertiesQCOM",  out vkGetDynamicRenderingTilePropertiesQCOM_ptr);
			NativeLib.LoadDeviceFunction("vkCreateSemaphoreSciSyncPoolNV",  out vkCreateSemaphoreSciSyncPoolNV_ptr);
			NativeLib.LoadDeviceFunction("vkDestroySemaphoreSciSyncPoolNV",  out vkDestroySemaphoreSciSyncPoolNV_ptr);
			...
			NativeLib.LoadDeviceFunction("vkConvertCooperativeVectorMatrixNV",  out vkConvertCooperativeVectorMatrixNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdConvertCooperativeVectorMatrixNV",  out vkCmdConvertCooperativeVectorMatrixNV_ptr);
			NativeLib.LoadDeviceFunction("vkSetLatencySleepModeNV",  out vkSetLatencySleepModeNV_ptr);
			NativeLib.LoadDeviceFunction("vkLatencySleepNV",  out vkLatencySleepNV_ptr);
			NativeLib.LoadDeviceFunction("vkSetLatencyMarkerNV",  out vkSetLatencyMarkerNV_ptr);
			NativeLib.LoadDeviceFunction("vkGetLatencyTimingsNV",  out vkGetLatencyTimingsNV_ptr);
			NativeLib.LoadDeviceFunction("vkQueueNotifyOutOfBandNV",  out vkQueueNotifyOutOfBandNV_ptr);
			...
			NativeLib.LoadDeviceFunction("vkCmdSetAttachmentFeedbackLoopEnableEXT",  out vkCmdSetAttachmentFeedbackLoopEnableEXT_ptr);
			NativeLib.LoadDeviceFunction("vkGetScreenBufferPropertiesQNX",  out vkGetScreenBufferPropertiesQNX_ptr);
			NativeLib.LoadDeviceFunction("vkCmdSetDescriptorBufferOffsets2EXT",  out vkCmdSetDescriptorBufferOffsets2EXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBindDescriptorBufferEmbeddedSamplers2EXT",  out vkCmdBindDescriptorBufferEmbeddedSamplers2EXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBindTileMemoryQCOM",  out vkCmdBindTileMemoryQCOM_ptr);
			NativeLib.LoadDeviceFunction("vkCreateExternalComputeQueueNV",  out vkCreateExternalComputeQueueNV_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyExternalComputeQueueNV",  out vkDestroyExternalComputeQueueNV_ptr);
			NativeLib.LoadFunction("vkGetExternalComputeQueueDataNV",  out vkGetExternalComputeQueueDataNV_ptr);
			NativeLib.LoadDeviceFunction("vkGetClusterAccelerationStructureBuildSizesNV",  out vkGetClusterAccelerationStructureBuildSizesNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBuildClusterAccelerationStructureIndirectNV",  out vkCmdBuildClusterAccelerationStructureIndirectNV_ptr);
			NativeLib.LoadDeviceFunction("vkGetPartitionedAccelerationStructuresBuildSizesNV",  out vkGetPartitionedAccelerationStructuresBuildSizesNV_ptr);
			NativeLib.LoadDeviceFunction("vkCmdBuildPartitionedAccelerationStructuresNV",  out vkCmdBuildPartitionedAccelerationStructuresNV_ptr);
			NativeLib.LoadDeviceFunction("vkGetGeneratedCommandsMemoryRequirementsEXT",  out vkGetGeneratedCommandsMemoryRequirementsEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdPreprocessGeneratedCommandsEXT",  out vkCmdPreprocessGeneratedCommandsEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdExecuteGeneratedCommandsEXT",  out vkCmdExecuteGeneratedCommandsEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCreateIndirectCommandsLayoutEXT",  out vkCreateIndirectCommandsLayoutEXT_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyIndirectCommandsLayoutEXT",  out vkDestroyIndirectCommandsLayoutEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCreateIndirectExecutionSetEXT",  out vkCreateIndirectExecutionSetEXT_ptr);
			NativeLib.LoadDeviceFunction("vkDestroyIndirectExecutionSetEXT",  out vkDestroyIndirectExecutionSetEXT_ptr);
			NativeLib.LoadDeviceFunction("vkUpdateIndirectExecutionSetPipelineEXT",  out vkUpdateIndirectExecutionSetPipelineEXT_ptr);
			NativeLib.LoadDeviceFunction("vkUpdateIndirectExecutionSetShaderEXT",  out vkUpdateIndirectExecutionSetShaderEXT_ptr);
			...
			NativeLib.LoadDeviceFunction("vkGetMemoryMetalHandleEXT",  out vkGetMemoryMetalHandleEXT_ptr);
			NativeLib.LoadDeviceFunction("vkGetMemoryMetalHandlePropertiesEXT",  out vkGetMemoryMetalHandlePropertiesEXT_ptr);
			NativeLib.LoadDeviceFunction("vkCmdEndRendering2EXT",  out vkCmdEndRendering2EXT_ptr);
		}

		public static void LoadDeviceFunctionPointers(VkDevice device = default)
		{
			if (device != default)
			{
				NativeLib.device = device;
			}
