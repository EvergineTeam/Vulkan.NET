...
namespace Evergine.Bindings.Vulkan
{
	public static unsafe partial class VulkanNative
	{
		...
		public static void LoadDeviceFunctionPointers(VkDevice device = default)
		{
			...
			NativeLib.LoadDeviceFunction("vkGetPhysicalDevicePresentRectanglesKHR",  out vkGetPhysicalDevicePresentRectanglesKHR_ptr);
			...
			NativeLib.LoadDeviceFunction("vkGetPhysicalDeviceVideoCapabilitiesKHR",  out vkGetPhysicalDeviceVideoCapabilitiesKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetPhysicalDeviceVideoFormatPropertiesKHR",  out vkGetPhysicalDeviceVideoFormatPropertiesKHR_ptr);
			...
			NativeLib.LoadDeviceFunction("vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR",  out vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR_ptr);
			NativeLib.LoadDeviceFunction("vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR",  out vkGetPhysicalDeviceQueueFamilyPerformanceQueryPassesKHR_ptr);
			...
			NativeLib.LoadDeviceFunction("vkGetPhysicalDeviceMultisamplePropertiesEXT",  out vkGetPhysicalDeviceMultisamplePropertiesEXT_ptr);
			...
			NativeLib.LoadDeviceFunction("vkGetPhysicalDeviceCalibrateableTimeDomainsKHR",  out vkGetPhysicalDeviceCalibrateableTimeDomainsKHR_ptr);
			...
			NativeLib.LoadDeviceFunction("vkGetPhysicalDeviceFragmentShadingRatesKHR",  out vkGetPhysicalDeviceFragmentShadingRatesKHR_ptr);
			...
			NativeLib.LoadDeviceFunction("vkGetPhysicalDeviceCooperativeMatrixPropertiesNV",  out vkGetPhysicalDeviceCooperativeMatrixPropertiesNV_ptr);
			NativeLib.LoadDeviceFunction("vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV",  out vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV_ptr);
			NativeLib.LoadDeviceFunction("vkGetPhysicalDeviceSurfacePresentModes2EXT",  out vkGetPhysicalDeviceSurfacePresentModes2EXT_ptr);
			...
			NativeLib.LoadDeviceFunction("vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR",  out vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHR_ptr);
			...
			NativeLib.LoadDeviceFunction("vkGetPhysicalDeviceRefreshableObjectTypesKHR",  out vkGetPhysicalDeviceRefreshableObjectTypesKHR_ptr);
			...
			NativeLib.LoadDeviceFunction("vkAcquireWinrtDisplayNV",  out vkAcquireWinrtDisplayNV_ptr);
			NativeLib.LoadDeviceFunction("vkGetWinrtDisplayNV",  out vkGetWinrtDisplayNV_ptr);
			...
			NativeLib.LoadDeviceFunction("vkGetPhysicalDeviceSciSyncAttributesNV",  out vkGetPhysicalDeviceSciSyncAttributesNV_ptr);
			...
			NativeLib.LoadDeviceFunction("vkGetPhysicalDeviceExternalMemorySciBufPropertiesNV",  out vkGetPhysicalDeviceExternalMemorySciBufPropertiesNV_ptr);
			NativeLib.LoadDeviceFunction("vkGetPhysicalDeviceSciBufAttributesNV",  out vkGetPhysicalDeviceSciBufAttributesNV_ptr);
			...
			NativeLib.LoadDeviceFunction("vkGetPhysicalDeviceOpticalFlowImageFormatsNV",  out vkGetPhysicalDeviceOpticalFlowImageFormatsNV_ptr);
			...
			NativeLib.LoadDeviceFunction("vkGetPhysicalDeviceCooperativeVectorPropertiesNV",  out vkGetPhysicalDeviceCooperativeVectorPropertiesNV_ptr);
			...
			NativeLib.LoadDeviceFunction("vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR",  out vkGetPhysicalDeviceCooperativeMatrixPropertiesKHR_ptr);
			...
			NativeLib.LoadDeviceFunction("vkGetExternalComputeQueueDataNV",  out vkGetExternalComputeQueueDataNV_ptr);
			...
			NativeLib.LoadDeviceFunction("vkGetPhysicalDeviceCooperativeMatrixFlexibleDimensionsPropertiesNV",  out vkGetPhysicalDeviceCooperativeMatrixFlexibleDimensionsPropertiesNV_ptr);
